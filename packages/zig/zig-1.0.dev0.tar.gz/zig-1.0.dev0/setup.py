...
setup(
    ...
    version="1.0.dev",  # Required
    # This is a one-line description or tagline of what your project does. This
    # corresponds to the "Summary" metadata field:
    # https://packaging.python.org/specifications/core-metadata/#summary
    description="Web Framework for MI and AI applications",  # Optional
    ...
    url="https://github.com/EdenInTheEast/zig",  # Optional
    # This should be your name or the name of the organization which owns the
    # project.
    author="Kib Gan",  # Optional
    # This should be a valid email address corresponding to the author listed
    # above.
    author_email="alterrxalter@gmail.com",  # Optional
    ...
    project_urls={  # Optional
        ...
        "Source": "https://github.com/EdenInTheEast/zig",
    },
)
