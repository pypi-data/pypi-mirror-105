...
class ListMember(lister.Lister):
    ...
    def take_action(self, parsed_args):
        ...
        data = self.app.client_manager.vpn_server.member_list(
            pool_id=pool_id)
...
class ShowMember(command.ShowOne):
    ...
    def take_action(self, parsed_args):
        ...
        if (uuidutils.is_uuid_like(parsed_args.pool) and
            ...
            try:
                data = self.app.client_manager.vpn_server.member_show(
...
class CreateMember(command.ShowOne):
    ...
    def take_action(self, parsed_args):
        ...
        body = {"member": attrs}
        data = self.app.client_manager.vpn_server.member_create(
            pool_id=pool_id,
            json=body
        )

        if parsed_args.wait:
            pool = self.app.client_manager.vpn_server.pool_show(pool_id)
            ...
            data = {
                'member': (
                    self.app.client_manager.vpn_server.member_show(
...
class SetMember(command.Command):
    ...
    def take_action(self, parsed_args):
        ...
        self.app.client_manager.vpn_server.member_set(
            pool_id=pool_id,
            member_id=member_id,
            json=post_data
        )
...
class DeleteMember(command.Command):
    ...
    def take_action(self, parsed_args):
        ...
        self.app.client_manager.vpn_server.member_delete(
            pool_id=pool_id,
            member_id=id
        )
...
class UnsetMember(command.Command):
    ...
    def take_action(self, parsed_args):
        ...
        member_id = v2_utils.get_resource_id(
            self.app.client_manager.vpn_server.member_list,
            'members', member_dict)
