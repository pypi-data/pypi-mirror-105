...
class RpiPicoGateway(GatewayBaseAIO):
    ...
    async def set_mode_analog_input(self, topic, payload):
        ...
        await self.pico.set_pin_mode_analog_input(pin, self.analog_input_callback)
    ...
    async def set_mode_digital_input(self, topic, payload):
        ...
        await self.pico.set_pin_mode_digital_input(pin, self.digital_input_callback)
    ...
    async def set_mode_servo(self, topic, payload):
        ...
        await self.pico.set_pin_mode_servo(pin)
