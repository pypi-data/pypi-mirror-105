#I have never made a module before, so if you got any advice feel free to tell me, if there is a way of contacting me - I do not know yet, will probably do that another time...
...
def bitctrl(buttonA,buttonB,buttonAB):
    ...
    #in your own script, like the example shown above.
        if s_inst.in_waiting:
            ...
            if packet.strip() == 'AB':
                #you can comment this out if you do not wish to press any keys, and simply only want to return a string, or the other way around
