...
if __name__ == '__main__':
    ...
    # print(mar.get_excels(IMAP_SPType.IMAP_QQ, user_name, password, b'496'))

    mar = MailAttachmentRetriever('./nav_data', ['xls', 'xlsx', 'pdf'])
    print(mar.get_excels('imap.mxhichina.com:993', 'share_price_received@yh-capital.cn', 'Yhtz2018', b'179'))
