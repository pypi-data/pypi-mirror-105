...
class ADNIResNet(nn.Module):
    def __init__(self, in_depth=1, n_blocks=[2, 2, 2, 2], interm_depths=[8, 8, 16, 32], bottleneck=False, n_out_linear=1, dropout=0.5):
        super(ADNIResNet, self).__init__()
        self.name = 'ADNIResnet'
