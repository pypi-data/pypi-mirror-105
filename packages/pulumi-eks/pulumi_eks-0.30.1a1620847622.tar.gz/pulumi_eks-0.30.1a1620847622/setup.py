...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'eks', '0.30.1-alpha.1620847622+4598fed1'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource eks 0.30.1-alpha.1620847622+4598fed1`
                """)
            else:
                raise
