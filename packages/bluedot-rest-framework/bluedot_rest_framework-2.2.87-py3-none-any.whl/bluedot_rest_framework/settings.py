...
DEFAULTS_SETTINGS = {
    ...
    'api_auth': {
        'models': 'bluedot_rest_framework.api_auth.models.AuthUser',
        'serializers': 'bluedot_rest_framework.api_auth.serializers.AuthUserSerializer',
        'views': 'bluedot_rest_framework.api_auth.views.AuthUserViewSet',
    },
    'user': {
        'models': 'bluedot_rest_framework.user.models.User',
        'serializers': 'bluedot_rest_framework.user.serializers.UserSerializer',
        'views': 'bluedot_rest_framework.user.views.AuthUserViewSet',
    },
    'material': {
