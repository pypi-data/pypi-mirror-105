...
class CoreModel:
    ...
    def getModelList(self):
        try:
            ...
            print("--------------------------------------")
            for name in ["Angle", "Force", "Moment", "Power", "COM","JC"]:
                if name == "JC":
                    print("Joint center data")
                else:
                ...
                for i in header:
                    if name in i:
                        if name == "JC":
                            ...
                            if "Left" in i:
                                print((i.split("eft")[0]+i.split("eft")[1])[:-3])
                            elif "Right" in i:
                                print((i.split("ight")[0]+i.split("ight")[1])[:-3])
                            else:
                                print(i[:-3])
                        else:
            ...
            print("==============")
            for i in header:
                if ("Angle" not in i) & ("Force" not in i) & ("Moment" not in i) & ("Power" not in i) & ("COM" not in i) &("JC" not in i):
                    print(i)
...
# method for getting raw model data.
    ...
    @retrivingModelData(True)
    @isModelName("angles")
    def getJointAngle(self,name,unit="degree"):
        """Summary line.
    ...
    @retrivingModelData(True)
    @isModelName("abs")
    def getAbsJointAngle(self, name, unit="degree"):
        """Summary line.
    ...
    @retrivingModelData(False)
    @isModelName("angles")
    def getJointAngleVel(self,name,unit="degree"):
        """Summary line.
    ...
    @retrivingModelData(False)
    @isModelName("angles")
    def getJointAngleAcc(self,name,unit="degree"):
        """Summary line.
    ...
    def getAbsJointAngleVel(self, name,unit="degree"):
        """Summary line.
    ...
    @retrivingModelData(False)
    @isModelName("abs") # 何故かanglesになっていた。absに修正。
    def getAbsJointAngleAcc(self, name, unit="degree"):
        """Summary line.
...
# method for getting  data divided by trigger.
    ...
    @dividingData(dimension=3)
    def divJointAngle(self,name, **kwargs):
        """Summary line.
        ...
        if "unit" in kwargs.keys():
            return self.getJointAngle(name, unit=kwargs["unit"])
        else:
    ...
    @cvt_divHumoArray(argsType="general")
    @dividingData(dimension=3)
    def divAbsJointAngle(self, name, **kwargs):
        """Summary line.
        ...
        """
        if "unit" in kwargs.keys():
            return self.getAbsJointAngle(name, unit=kwargs["unit"])
        else:
    ...
    @cvt_divHumoArray(argsType="general")
    @dividingData(dimension=3)
    def divJointAngleVel(self, name, **kwargs):
        """Summary line.
        ...
        """
        if "unit" in kwargs.keys():
            return self.getJointAngleVel(name, unit=kwargs["unit"])
        else:
    ...
    @cvt_divHumoArray(argsType="general")
    @dividingData(dimension=3)
    def divJointAngleAcc(self, name, **kwargs):
        """Summary line.
        ...
        """
        if "unit" in kwargs.keys():
            return self.getJointAngleAcc(name, unit=kwargs["unit"])
        else:
    ...
    @cvt_divHumoArray(argsType="general")
    @dividingData(dimension=3)
    def divAbsJointAngleVel(self, name, **kwargs):
        """Summary line.
		...
		In short, it's just obj [0 :: 2].
        """
        if "unit" in kwargs.kesy():
            return self.getAbsJointAngleVel(name, unit=kwargs["unit"])
        else:
    ...
    @cvt_divHumoArray(argsType="general")
    @dividingData(dimension=3)
    def divAbsJointAngleAcc(self, name, **kwargs):
        """Summary line.
        Get joint angle acceleration separated by trigger.
        ...
        """
        if "unit" in kwargs.keys():
            return self.getAbsJointAngleAcc(name, unit=kwargs["unit"])
        else:
