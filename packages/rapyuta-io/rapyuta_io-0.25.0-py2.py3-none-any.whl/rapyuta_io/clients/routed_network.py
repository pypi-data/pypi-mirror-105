...
class RoutedNetwork(ObjDict):
    """
    RoutedNetwork represents Routed Network

    :ivar name: Name of RoutedNetwork.
    :ivar runtime: Runtime of RoutedNetwork enum :py:class:`~rapyuta_io.clients.package.Runtime`.
    :ivar rosDistro: ROSDistro of RoutedNetwork enum :py:class:`~rapyuta_io.clients.package.ROSDistro`.
    :ivar shared: Whether the network can be shared (bool).
    :ivar parameters: parameters of the routed network :py:class:`~rapyuta_io.clients.routed_network.Parameters`
    :ivar phase: Deployment phase :py:class:`~rapyuta_io.clients.deployment.DeploymentPhaseConstants`
    :ivar status: Deployment status :py:class:`~rapyuta_io.clients.deployment.DeploymentStatus`
    ...
    def get_status(self):
        ...
        routed_network = RoutedNetwork(to_objdict(response))
