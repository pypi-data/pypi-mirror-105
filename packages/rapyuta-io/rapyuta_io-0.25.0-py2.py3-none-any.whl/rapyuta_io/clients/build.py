...
class Build(ObjDict):
    ...
    def __init__(self, buildName, strategyType, repository, architecture, rosDistro='',
                 ...
                 simulationOptions=None, buildOptions=None, branch=''):
        ...
        self.validate(buildName, strategyType, repository, architecture, rosDistro, isRos,
                      ...
                      dockerPushRepository, simulationOptions, buildOptions, branch)
    ...
    def refresh(self):
        ...
        """
        Update the build object with parameter values from server.

        Following example demonstrates how to refresh a build:
