...
class Client(object):
    ...
    def trigger_build(self, buildOperationInfo):

        """
        Trigger a new build request for a particular build

        :param buildOperationInfo: Info of the operation to be performed on the build.
        :type  buildOperationInfo: :py:class:`~rapyuta_io.clients.buildoperation.BuildOperation`
        ...
        """
        return self._catalog_client.trigger_build(buildOperationInfo=buildOperationInfo)

    def rollback_build(self, buildOperationInfo):
        ...
        """
        return self._catalog_client.rollback_build(buildOperationInfo=buildOperationInfo)
    ...
    def create_native_network(self, native_network):
        ...
        if native_network.runtime != Runtime.CLOUD:
            raise InvalidParameterException(
                "Runtime of the Native Network must be cloud")
