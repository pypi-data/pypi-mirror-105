...
class CRMLeadLinesRemesaWizard(models.TransientModel):
    ...
    def default_get(self, fields_list):
        ...
        if errors:
            defaults['errors'] = "The nexts CRMLeadLines have a phone number that already exists in another contract/CRMLead: {}".format(  # noqa
                " ".join(
        ...
        for line in crm_lead_lines:
            if len(line.lead_id.lead_line_ids) > 1:
                ...
                try:
                    ...
                    if error.name == _("Contract or validated CRMLead with the same phone already exists."):  # noqa
