...
###########
def Potts_Random_Partition (Train_PottsData, T, sigma, Number_of_Random_Partitions, Initial_Partition,  Kernel="Mercel") : 
    ...
    while k < (Number_of_Random_Partitions + 1):
            ...
            AdjustedPartition = AdjustPartition(New_Partition,5, Train_PottsData)
...
#Partitions_Sets,Spin_Configuration_Sets = Potts_Random_Partition (Train_PottsData, T, sigma, Number_of_Random_Partitions, Initial_Partition,  Kernel="Mercel")
