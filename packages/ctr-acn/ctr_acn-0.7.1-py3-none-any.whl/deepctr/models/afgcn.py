...
from ..layers.interaction import FEGCNNLayer, ANLayer
from ..layers.utils import concat_func, add_func


def AFGCN(linear_feature_columns, dnn_feature_columns, 
        conv_kernel_width=((7, 1), (7, 1)), conv_filters=(14, 16), pooling_width=(2, 2), new_maps=(3, 3),
        attention_factor=8,
    ...
    ext_features = FEGCNNLayer(conv_filters, conv_kernel_width, pooling_width, new_maps)(cnn_input)      
