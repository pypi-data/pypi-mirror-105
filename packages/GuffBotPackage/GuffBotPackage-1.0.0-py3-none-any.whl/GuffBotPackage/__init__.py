...
<div class="sidebar-heading" style="margin-bottom : 1em;">BOT INFO</div>
<li class="nav-item active">
...
<hr class="sidebar-divider my-0">
<li class="nav-item">
<a class="nav-link" href="https://tiktok.com/@noteason">
<i class=""></i>
<span>Made By noteason with ❤</span>
</a>
 </li>
...
<a href="https://youtbe.com" class="d-none d-sm-inline-block btn btn-sm btn-info shadow-sm"><i class="fas fa-redo"></i> Refresh</a>
</div>
...
<div class="col mr-2">
<div class="text-xs font-weight-bold text-info text-uppercase mb-1">Party</div>
...
<div class="row no-gutters align-items-center">
<div class="col mr-2">
<div class="text-xs font-weight-bold text-info text-uppercase mb-1">Friends</div>
<div class="h5 mb-0 font-weight-bold text-gray-800">{len(friends)} / 1000</div>
</div>
<div class="col-auto">
<i class="fab fa-discord fa-2x text-gray-300"></i>
</div>
...
<div class="row no-gutters align-items-center">
<div class="col mr-2">
<div class="text-xs font-weight-bold text-info text-uppercase mb-1">CID</div>
<div class="h5 mb-0 font-weight-bold text-gray-800">{client.party.me.outfit}</div>
</div>
<div class="col-auto">
<i class="fab fa-discord fa-2x text-gray-300"></i>
</div>
...
<div class="h5 mb-0 font-weight-bold text-gray-800">{client.party.me.emote}</div>
</div>
<div class="col-auto">
<i class="fab fa-discord fa-2x text-gray-300"></i>
</div>
...
@discord_bot.event
async def on_ready():
    print(f'Discord Client Ready As {discord_bot.user.name}')
    print('All Clients Ready')
    print(f'{discord_bot.user.id}')
