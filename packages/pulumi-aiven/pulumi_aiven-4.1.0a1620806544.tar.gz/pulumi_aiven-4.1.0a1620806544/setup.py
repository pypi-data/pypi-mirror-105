...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'aiven', '4.1.0-alpha.1620806544+ca59ed32'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource aiven 4.1.0-alpha.1620806544+ca59ed32`
                """)
            else:
                raise
