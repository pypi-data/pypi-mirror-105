...
if __name__ == "__main__":
    ...
    example_text = pd.read_csv("../../text-mining-datasets/data/pan-2017-age/train.tsv", sep="\t")['text_a']
    labels = pd.read_csv("../../text-mining-datasets/data/pan-2017-age/train.tsv", sep="\t")['label'].values.tolist()
