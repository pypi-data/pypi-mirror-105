...
# def CAT_VS_DOG_v2():
#     data_cache_dir = os.path.join(os.path.expanduser('~'), '.keras', 'datasets')
#     path = gdd.download_file_from_google_drive(file_id='1vYnnZAkd1EshXaAOR5QHcHLaTYz--dox',
#                                                dest_path=os.path.join(data_cache_dir, 'cat_vs_dog.tar.gz'),
#                                                unzip=True)
...
#     test_X, test_Y = load_data(path, mode='train')
