...
setup(
  ...
  version = '1.3.14',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://gitlab.com/antoreep_jana/quick_ml/-/archive/v1.3.14/quick_ml-v1.3.14.tar.gz',    # I explain this later on
