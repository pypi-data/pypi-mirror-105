...
function GetOciSubcommands_network() {
    $ociSubcommands = @{
        ...
        'network internal-public-ip' = 'delete-drg-route-table'
...
function GetOciCommandsToLongParams_network() {
    $ociCommandsToLongParams = @{
        ...
        'network internal-public-ip delete-drg-route-table' = 'drg-route-table-id force from-json help if-match max-wait-seconds wait-for-state wait-interval-seconds'
...
function GetOciCommandsToShortParams_network() {
    $ociCommandsToShortParams = @{
        ...
        'network internal-public-ip delete-drg-route-table' = '? h'
