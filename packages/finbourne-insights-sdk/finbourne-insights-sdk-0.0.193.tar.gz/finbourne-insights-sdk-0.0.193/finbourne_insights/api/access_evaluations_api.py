...
class AccessEvaluationsApi(object):
    ...
    def get_access_evaluation_log(self, id, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] Get the log for a specific access evaluation.  # noqa: E501
        ...
        :param str id: The identifier of the access evaluation to obtain the log for. (required)
    ...
    def get_access_evaluation_log_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(AccessEvaluationLog, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            ...
            response_type='AccessEvaluationLog',  # noqa: E501
    ...
    def list_access_evaluation_logs(self, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] List the logs for access evaluations.  # noqa: E501
        ...
        :param str histogram_interval: The interval for an included histogram of the logs
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def list_access_evaluation_logs_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(ResourceListWithHistogramOfAccessEvaluationLog, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if 'filter' in local_var_params and not re.search(r'(?s).*', local_var_params['filter']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `filter` when calling `list_access_evaluation_logs`, must conform to the pattern `/(?s).*/`")  # noqa: E501
        ...
        if 'sort_by' in local_var_params and not re.search(r'(?s).*', local_var_params['sort_by']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `sort_by` when calling `list_access_evaluation_logs`, must conform to the pattern `/(?s).*/`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ResourceListWithHistogramOfAccessEvaluationLog',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
