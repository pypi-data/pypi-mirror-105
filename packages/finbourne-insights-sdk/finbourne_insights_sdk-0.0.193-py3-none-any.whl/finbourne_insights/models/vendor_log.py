...
class VendorLog(object):
    ...
    def __init__(self, id=None, provider=None, timestamp=None, type=None, destination_url=None, operation=None, outcome=None, duration=None, http_status_code=None, user_id=None, request_id=None, links=None):  # noqa: E501
        """
