...
class ResourceListWithHistogramOfAccessEvaluationLog(object):
    ...
    def __init__(self, histogram=None, values=None, href=None, next_page=None, previous_page=None, links=None):  # noqa: E501
        """
    ...
    def values(self):
        ...
        :rtype: list[AccessEvaluationLog]
        """
        return self._values
