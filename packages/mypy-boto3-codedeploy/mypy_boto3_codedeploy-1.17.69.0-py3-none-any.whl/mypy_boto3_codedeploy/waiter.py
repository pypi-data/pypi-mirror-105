...
class DeploymentSuccessfulWaiter(Boto3Waiter):
    ...
    def wait(self, deploymentId: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.69/reference/services/codedeploy.html#CodeDeploy.Waiter.DeploymentSuccessfulWaiter)
