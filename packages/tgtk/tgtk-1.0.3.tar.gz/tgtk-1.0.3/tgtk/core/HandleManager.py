...
from tgtkconsts.ExecVarsSample import ExecVars
from tgtkcore.getCommand import get_command
from tgtkcore.getVars import get_val
from tgtkfunctions.Leech_Module import check_link,cancel_torrent,pause_all,resume_all,purge_all,get_status,print_files, get_transfer
from tgtkfunctions.tele_upload import upload_a_file,upload_handel
from tgtkfunctions import Human_Format
from tgtkcore.database_handle import tkupload,tktorrents, tkdb
from tgtkcore.settings import handle_settings,handle_setting_callback
from tgtkcore.user_settings import handle_user_settings, handle_user_setting_callback
from functools import partial
from tgtkfunctions.rclone_upload import get_config, rclone_driver
from tgtkfunctions.admin_check import is_admin
...
from tgtkcore.ttk_ytdl import handle_ytdl_command,handle_ytdl_callbacks,handle_ytdl_file_download,handle_ytdl_playlist,handle_ytdl_playlist_down
from tgtkfunctions.instadl import _insta_post_downloader
