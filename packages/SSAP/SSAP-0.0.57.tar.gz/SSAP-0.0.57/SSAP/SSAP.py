...
# dutycycle | 20.dec.10
def dutycycle(df, speed_name, torque_name, stepx, stepy, bubblesize, xlimleft,xlimright,ylimleft,ylimright,title):
    from scipy.interpolate import griddata
    import matplotlib.pyplot as plt
    import pandas as pd
    import numpy as np
    ...
    ax.set_ylim(ylimleft,ylimright)
...
df=pd.read_csv('C:/Users/lx379/Desktop/9_1.csv')
dutycycle(df,'ESPDAve(rpm)','TorquePercentage_(%)',100,10,20,0,2000,0,100,'15N KnockDerate Vehicle Dutycycle')
...
# df=pd.read_csv('C:/Users/lx379/Python_Tony/tony_lab/showcase_data/m01_pol_reg.csv')
# polynominalreg(df,'para-1','para-2',5,'demo')
