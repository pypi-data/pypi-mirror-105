...
StickIt_VGA_lib = SchLib(tool=SKIDL).add_parts(*[
        Part(**{ 'name':'PMOD-12', 'dest':TEMPLATE, 'tool':SKIDL, 'description':'', 'value_str':'PMOD-12', 'datasheet':'', '_match_pin_regex':False, 'tool_version':'kicad', 'symtx':'H', 'keywords':'', 'ref_prefix':'PM', 'num_units':1, 'fplist':[], 'do_erc':True, 'aliases':Alias(), 'pin':None, 'footprint':'xesscorp/xess.pretty:PMOD-12-MALE', 'pins':[
        ...
        Part(**{ 'name':'Conn_01x18_Male', 'dest':TEMPLATE, 'tool':SKIDL, 'description':'Generic connector, single row, 01x18, script generated (kicad-library-utils/schlib/autogen/connector/)', 'value_str':'Conn_01x18_Male', 'datasheet':'~', '_match_pin_regex':False, 'tool_version':'kicad', 'keywords':'connector', 'ref_prefix':'J', 'num_units':1, 'fplist':['Connector*:*_1x??_*'], 'do_erc':True, 'aliases':Alias(), 'pin':None, 'footprint':'KiCad_V5/Connector_PinHeader_2.54mm.pretty:Pin_Header_1x18_P2.54mm_Vertical', 'pins':[
        ...
        Part(**{ 'name':'RN4', 'dest':TEMPLATE, 'tool':SKIDL, 'description':'', 'value_str':'8635', 'datasheet':'', '_match_pin_regex':False, 'tool_version':'kicad', 'keywords':'', 'ref_prefix':'RN', 'num_units':4, 'fplist':[], 'do_erc':True, 'aliases':Alias(), 'pin':None, 'footprint':'xesscorp/xess.pretty:CTS_742C083', 'pins':[
        ...
        Part(**{ 'name':'DB15_Female_HighDensity_MountingHoles', 'dest':TEMPLATE, 'tool':SKIDL, 'description':'15-pin female D-SUB connector, High density (3 columns), Triple Row, Generic, VGA-connector, Mounting Hole', 'value_str':'DB15_Female_HighDensity_MountingHoles', 'datasheet':'~', '_match_pin_regex':False, 'tool_version':'kicad', 'keywords':'connector db15 female D-SUB VGA', 'ref_prefix':'J', 'num_units':1, 'fplist':['DSUB*Female*'], 'do_erc':True, 'aliases':Alias(), 'pin':None, 'footprint':'xesscorp/xess.pretty:DB15-3.08mm-HD-FEMALE', 'pins':[
