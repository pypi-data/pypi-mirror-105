...
def cli(ctx: Context):
    raise NotImplementedError("This functionality is currently not implemented. Please use 'kamo auth' and enter API Key")
    PORT = 9898
    ...
    class Handler(http.server.SimpleHTTPRequestHandler):
        def do_GET(self):
            ...
            if query_components:
                ...
                create_profile(
                    get_default_profile(), api_key=refresh_token, domain=profile["domain"]
                )
