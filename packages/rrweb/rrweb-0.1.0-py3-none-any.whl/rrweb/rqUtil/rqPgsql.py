...
from rrweb.rqUtil.rqLogs import (rq_util_log_debug, rq_util_log_expection,
                                             rq_util_log_info)

from rrweb.rqUtil import (rq_util_get_trade_range, rq_util_get_last_tradedate, 
...
def client_pgsql(database='rrweb'):
    try:
...
if __name__ == '__main__':
    ...
    path = '/home/rome/rrweb/rrweb/sql'
    ...
    with open(file_path, 'r') as f:
        tsql = f.read()
    #print(tsql)
    psql.create_table('rrweb','stock_day_fillna',tsql)
    """
    psql2 = PgsqlClass()
