...
import logging
from rrweb.rqUtil.rqSingleton import  ConSqlDb

from rrweb.rqUtil.rqDate_trade import (rq_util_get_trade_range, rq_util_get_last_tradedate, 
...
def read_sql_from_pg(start_date=None,data=None,table_name=None,client=client_pgsql()):
    ...
    try:
        ...
        t1=time.time()
        tt = t1-t
        print(f'read  data from {table_name} ,take {tt}')
        return res
    except Exception as e:
        print(e)
