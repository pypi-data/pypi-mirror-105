...
def main():  
    ...
    string = "你好，把这篇文章转发到你的朋友圈，即可向李兴球申请文章内的Python课程资源。转发的时候写上文字: “转发此文章即可向李兴球申请文章内的Python课程资源。”"


    ss = ['你好，世界','我是汉服姑娘','我也喜欢Python','你正在编程吗?'
          '据我所知','你也是Python爱好者','我们可是有共同爱好哟','么么哒']
    ...
    for c in string:
       s += c
       g.say(s,0.2,bg='yellow',fg='red',fz=15)
       
    g.say(string,3,bg='yellow',fg='red',fz=15)
