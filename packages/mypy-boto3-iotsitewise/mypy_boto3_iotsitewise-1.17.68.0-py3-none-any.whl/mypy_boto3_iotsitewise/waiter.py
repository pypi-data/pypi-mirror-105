...
class AssetActiveWaiter(Boto3Waiter):
    ...
    def wait(self, assetId: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.68/reference/services/iotsitewise.html#IoTSiteWise.Waiter.AssetActiveWaiter)
...
class AssetModelActiveWaiter(Boto3Waiter):
    ...
    def wait(self, assetModelId: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.68/reference/services/iotsitewise.html#IoTSiteWise.Waiter.AssetModelActiveWaiter)
...
class AssetModelNotExistsWaiter(Boto3Waiter):
    ...
    def wait(self, assetModelId: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.68/reference/services/iotsitewise.html#IoTSiteWise.Waiter.AssetModelNotExistsWaiter)
...
class AssetNotExistsWaiter(Boto3Waiter):
    ...
    def wait(self, assetId: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.68/reference/services/iotsitewise.html#IoTSiteWise.Waiter.AssetNotExistsWaiter)
...
class PortalActiveWaiter(Boto3Waiter):
    ...
    def wait(self, portalId: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.68/reference/services/iotsitewise.html#IoTSiteWise.Waiter.PortalActiveWaiter)
...
class PortalNotExistsWaiter(Boto3Waiter):
    ...
    def wait(self, portalId: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.68/reference/services/iotsitewise.html#IoTSiteWise.Waiter.PortalNotExistsWaiter)
