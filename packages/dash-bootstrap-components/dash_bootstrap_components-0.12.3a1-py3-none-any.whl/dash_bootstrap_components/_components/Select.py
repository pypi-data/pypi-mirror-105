...
- required (a value equal to: 'required', 'REQUIRED' | boolean; optional): This attribute specifies that the user must fill in a value before
...
- name (string; optional): The name of the control, which is submitted with the form data."""
    ...
    def __init__(self, id=Component.UNDEFINED, style=Component.UNDEFINED, className=Component.UNDEFINED, key=Component.UNDEFINED, placeholder=Component.UNDEFINED, value=Component.UNDEFINED, options=Component.UNDEFINED, disabled=Component.UNDEFINED, required=Component.UNDEFINED, valid=Component.UNDEFINED, invalid=Component.UNDEFINED, bs_size=Component.UNDEFINED, persistence=Component.UNDEFINED, persisted_props=Component.UNDEFINED, persistence_type=Component.UNDEFINED, name=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'style', 'className', 'key', 'placeholder', 'value', 'options', 'disabled', 'required', 'valid', 'invalid', 'bs_size', 'persistence', 'persisted_props', 'persistence_type', 'name']
        self._type = 'Select'
        self._namespace = 'dash_bootstrap_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'style', 'className', 'key', 'placeholder', 'value', 'options', 'disabled', 'required', 'valid', 'invalid', 'bs_size', 'persistence', 'persisted_props', 'persistence_type', 'name']
