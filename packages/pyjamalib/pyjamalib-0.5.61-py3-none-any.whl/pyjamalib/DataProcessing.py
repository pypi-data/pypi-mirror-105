...
class DataProcessing:
    ...
    def toDataframe(data,data_calib,low_pass=.1,freq=75,dt=1/75,alpha=.01,beta=.05,beta_mag=.9,beta_mag2=.01,conj=True):
        ...
        CF    = DataProcessing.complementaryFilter(Roll,Pitch,Yaw,gyr_df[:,0],gyr_df[:,1],gyr_df[:,2],alpha=.05,dt=dt)
        CF_GD = DataProcessing.ComplementaryFilterGD(acc_df,gyr_df,mag_df,dt=dt,alpha=alpha,beta=beta,conj=conj,low_pass=low_pass)
        CF_GN = DataProcessing.ComplementaryFilterGN(acc_df,gyr_df,mag_df,dt=dt,alpha=alpha,beta=beta,conj=conj,low_pass=low_pass)
        Kalman_GD = DataProcessing.KalmanGD(acc_df,gyr_df_f,mag_df,gyrcalib=kalamn_gyr,dt=dt,beta=beta,conj=conj,low_pass=low_pass)
        Kalman_GN = DataProcessing.KalmanGN(acc_df,gyr_df_f,mag_df,gyrcalib=kalamn_gyr,dt=dt,beta=beta,conj=conj,low_pass=low_pass)
