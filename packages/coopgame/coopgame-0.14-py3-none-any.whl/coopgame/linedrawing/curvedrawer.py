...
class CurveDrawer:
    ...
    def draw_bezier(self,
        ...
        if draw_points:
            for ii in range(len(translated_points)):
                pygame.draw.circle(screen, control_point_color.value, (int(translated_points[ii][0]), int(translated_points[ii][1])), 4)
    ...
    def draw_line(self,
        ...
        # Draw the points
        if draw_points:
            pygame.draw.circle(surface, control_point_color.value, (int(translated_points[0][0]), int(translated_points[0][1])), 4)
            pygame.draw.circle(surface, control_point_color.value, (int(translated_points[1][0]), int(translated_points[1][1])), 4)
