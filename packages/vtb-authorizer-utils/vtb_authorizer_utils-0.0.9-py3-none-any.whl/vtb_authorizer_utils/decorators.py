...
def authorizer_resource_rule(context_types: Set[ContextType],
                             http_method: str,
                             url_pattern: str,
                             access_type: str,
                             operation_name: str,
    ...
    def decorator(view_method):
        ...
        if not action_code:
            ...
            code = method_name if method_name == lower_http_method else f'{lower_http_method}_{method_name}'
        else:
            code = action_code

        AuthorizerSchemaBuilder().add_resource_rule(context_types, http_method.upper(), url_pattern,
                                                    code, access_type, operation_name, view_method.__qualname__)
        return view_method
