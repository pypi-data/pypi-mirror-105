...
class ListAttacksPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.68/reference/services/shield.html#Shield.Paginator.ListAttacks.paginate)
...
class ListProtectionsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.68/reference/services/shield.html#Shield.Paginator.ListProtections.paginate)
