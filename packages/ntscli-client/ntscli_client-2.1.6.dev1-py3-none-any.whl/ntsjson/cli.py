...
@click.option(
    ...
    help="Many set top boxes will lock to specific video output frequency over HDMI."
         "To inform EyePatch tests of this output frequency, please select one of [\"50Hz\", \"59.94Hz\", \"60Hz\"]",
    envvar="EP_FREQUENCY",
)
@click.option(
    "--audio-source",
    required=True,
    type=str,
    help="The EyePatch sensor device supports a few audio capture input methods: [\"line-in\", \"contact-mic\"]."
...
@click.option(
    ...
    help="The EyePatch sensor device can be used to measure audio/video for either a Smart TV device or a "
         "set-top-box device. [\"set-top-box\", \"smart tv\"]",
...
@click.option(
    "--eyepatch-serial",
    type=str,
    help="The serial number of the eyepatch to be used. Specify this if multiple eyepatches are connected to the RAE.",
    envvar="EP_SERIAL",
)
@click.option(
    "--golden",
...
@click.option(
    "--dv-mode",
    type=str,
    help="The Dolby Vision mode. [\"NA\", \"DV_STANDARD\", \"DV_LOWLATENCY\"]",
)
@click.option(
    "--audio-mode",
    type=str,
    help="The audio mode. [\"PASSTHROUGH\", \"ATMOS\", \"DDP51\", \"PCM\", \"DOLBYMAT\"]",
)
@click.option(
    "--video-mode",
    type=str,
    help="The video mode. [\"PASSTHROUGH\", \"ALWAYSHDR\"]",
)
@click.option(
    "--hdr-mode",
    type=str,
    help="The HDR mode. [\"HDR10\", \"DV_STANDARD\", \"DV_LOWLATENCY\"]",
)
@click.option(
