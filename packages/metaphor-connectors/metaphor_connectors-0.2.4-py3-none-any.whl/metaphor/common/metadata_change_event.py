...
class DashboardInfo:
    ...
    def from_dict(obj: Any) -> 'DashboardInfo':
        ...
        return DashboardInfo(id, aspect_type, created_at, description, entity_id, dashboard_info_id, latest, title)
...
class PersonProperties:
    ...
    def from_dict(obj: Any) -> 'PersonProperties':
        ...
        title = from_union([from_str, from_none], obj.get("title"))
        return PersonProperties(id, aspect_type, avatar_url, created_at, department, display_name, division, employee_number, entity_id, first_name, person_properties_id, last_login, last_name, latest, manager, manager_id, mobile_phone, occupation, organization, primary_phone, status, title)
...
class Person:
    ...
    def from_dict(obj: Any) -> 'Person':
        ...
        return Person(avatar_url, created_at, deleted_at, entity_type, first_name, id, last_modified_at, last_name, logical_id, password, properties)
