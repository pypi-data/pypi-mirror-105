...
from reinvent_scoring.scoring.score_components import RHClintPiP
...
class Test_pip_hlm_clint(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.expected_scores = [1.248, 0.85,  1.184]

        cls.component = RHClintPiP(parameters)
...
class Test_pip_hlm_clint_transformation(unittest.TestCase):
    def setUp(cls):
        ...
        cls.component = RHClintPiP(ts_parameters)
