...
from reinvent_scoring.scoring.score_components import CACO2IntrinsicPiP
...
class Test_pip_caco2_intr(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.expected_scores = [1.677, 0.794, 0.79 ]

        cls.component = CACO2IntrinsicPiP(parameters)
...
class Test_pip_caco2_intr_transformation(unittest.TestCase):
    def setUp(cls):
        ...
        cls.query_smiles = [celecoxib, 'CCC', "CCCCC"]
        cls.expected_raw_scores = [1.677, 0.794, 0.79 ]
