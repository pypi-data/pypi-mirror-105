...
from reinvent_scoring.scoring.score_components import CACO2EffluxPiP
...
class Test_pip_caco2_efflux(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.expected_scores = [0.761, 0.813, 0.815]

        cls.component = CACO2EffluxPiP(parameters)
...
class Test_pip_caco2_efflux_transformation(unittest.TestCase):
    def setUp(cls):
        ...
        cls.query_smiles = [celecoxib, "CCC", "CCCCC"]
        cls.expected_raw_scores = [0.761, 0.813, 0.815]
        cls.expected_scores = [0.19, 0.21, 0.21]
        cls.component = CACO2EffluxPiP(parameters)
