...
from unittest_reinvent.fixtures.paths import MAIN_TEST_PATH, AZDOCK_UNITTEST_JSON, AZDOCK_UNITTEST_OE_RECEPTOR_PATH, \
    AZDOCK_UNITTEST_REFERENCE_LIGAND_DPATH
...
class Test_structural_AZdock(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        azdock_conf["docking"]["ligand_preparation"]["embedding_pools"][0]["align"]["reference_paths"] = [AZDOCK_UNITTEST_REFERENCE_LIGAND_DPATH]
        ...
        cls.query_smiles = ["Cc1cc(Oc2nccc(CCC)c2)ccc1", "C1CCCCCCCCC1", "CCCCn1c(Cc2ccc3c(c2)OCO3)nc2c(N)ncnc21"]
    ...
    def test_AZdock(self):
        ...
        npt.assert_almost_equal(summary.total_score, [0.09428476, 0.0499051, 0.09785146], decimal=3)
