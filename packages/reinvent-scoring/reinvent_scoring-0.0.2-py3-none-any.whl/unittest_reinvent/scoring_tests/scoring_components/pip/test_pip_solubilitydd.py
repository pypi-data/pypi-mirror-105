...
from reinvent_scoring.scoring.score_components import SolubilityDDPiP
...
class Test_pip_solubilityDD(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.expected_scores = [0.420, 1.108, 1.733, 0.220]

        cls.component = SolubilityDDPiP(parameters)
...
class Test_pip_solubilityDD_transformation(unittest.TestCase):
    def setUp(cls):
        ...
        cls.query_smiles = [celecoxib, "CCC", "CCO", "CCCCC"]
        cls.expected_scores = [0.420, 1.108, 1.733, 0.220]
        cls.expected_scores = [0.0, 1.0, 1.0, 0.0]
        cls.component = SolubilityDDPiP(ts_parameters)
