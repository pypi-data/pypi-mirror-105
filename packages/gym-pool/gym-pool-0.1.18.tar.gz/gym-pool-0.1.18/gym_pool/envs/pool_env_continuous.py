...
class PoolEnv:
    ...
    def step(self, action):
        ...
        game = self.gamestate
        ball_pos, holes_in, collision_count, white_in, eight_in, smallest_distance, total_distance, done = game.step(game, real_action[0],real_action[1], new_state_space=True)
