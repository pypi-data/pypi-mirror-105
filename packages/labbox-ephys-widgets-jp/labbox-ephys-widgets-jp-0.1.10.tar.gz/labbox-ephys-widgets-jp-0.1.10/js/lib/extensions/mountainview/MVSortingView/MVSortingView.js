...
const MVSortingView = (props) => {
    ...
    const handleLaunchRecordingView = useCallback((plugin) => {
        openViewsDispatch({
            type: 'AddView',
            plugin,
            label: plugin.label,
        ...
        React.createElement(Splitter, { width: width, height: height, initialPosition: initialLeftPanelWidth },
            React.createElement("div", null,
                React.createElement(Expandable, { icon: launchIcon, label: "Open views", defaultExpanded: true, unmountOnExit: false },
                    React.createElement(ViewLauncher, { onLaunchSortingView: handleLaunchSortingView, onLaunchRecordingView: handleLaunchRecordingView, onLaunchSortingUnitView: handleLaunchSortingUnitView, selection: props.selection, hasSorting: hasSorting })),
                hasSorting && (React.createElement(Expandable, { icon: visibleUnitsIcon, label: "Visible units", defaultExpanded: false, unmountOnExit: false },
                ...
                curationDispatch && hasSorting && (React.createElement(Expandable, { icon: curationIcon, label: "Curation", defaultExpanded: false, unmountOnExit: false },
