...
class octid:
    def __init__(self, model = 'googlenet',customised_model = False, feature_dimension = 3, outlier_fraction_of_SVM = 0.03, training_dataset=None, validation_dataset=None, unlabeled_dataset=None):
        self.model_name = model
        self.dim = feature_dimension
        self.templates_path = training_dataset
