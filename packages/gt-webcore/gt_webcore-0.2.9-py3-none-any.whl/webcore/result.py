...
class Result(object):    
    ...
    def error(cls, base_error = None):
        if (base_error == None):
            ...
            return Result(base_error.code, base_error.msg, base_error.sub_code)

    @classmethod
    def http_error(cls, msg = None, sub_code=None):
        return Result(Error.HTTP_ERROR,  msg or 'http error', sub_code)
    
    @classmethod
    def db_error(cls, sub_code=None):
        return Result(Error.DB_ERROR, 'database error', sub_code)
