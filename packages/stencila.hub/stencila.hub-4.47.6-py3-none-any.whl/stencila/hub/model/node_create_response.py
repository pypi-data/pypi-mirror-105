...
class NodeCreateResponse(ModelNormal):
    ...
    def __init__(self, project, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            key (str): A unique, and very difficult to guess, key to access this node if it is not public.. [optional] if omitted the server will use the default value of "V3EdNQSSXJ3dmJ9Sb5URPEfBfj8SFtYn"  # noqa: E501
