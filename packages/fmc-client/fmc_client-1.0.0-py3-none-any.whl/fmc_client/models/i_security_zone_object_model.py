...
class ISecurityZoneObjectModel(object):
    ...
    def __init__(self, interface_mode=None, interfaces=None, metadata=None, name=None, overridable=None, description=None, links=None, overrides=None, id=None, type=None, version=None, _configuration=None):  # noqa: E501
