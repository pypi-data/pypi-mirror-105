...
class VrfOspfPolicyModel(object):
    ...
    def __init__(self, metadata=None, filter_rules=None, log_adjacency_changes=None, description=None, enable_process=None, areas=None, summary_addresses=None, type=None, version=None, process_id=None, neighbors=None, process_configuration=None, name=None, links=None, redistribute_protocols=None, id=None, _configuration=None):  # noqa: E501
