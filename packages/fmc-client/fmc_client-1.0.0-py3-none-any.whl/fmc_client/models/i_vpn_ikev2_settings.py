...
class IVpnIkev2Settings(object):
    ...
    def __init__(self, automatic_pre_shared_key_length=None, certificate_auth=None, enforce_hex_based_pre_shared_key_only=None, authentication_type=None, manual_pre_shared_key=None, policy=None, _configuration=None):  # noqa: E501
