...
class IFPPhysicalInterface(object):
    ...
    def __init__(self, metadata=None, description=None, type=None, version=None, enabled=None, mtu=None, mode=None, interface_type=None, mdi=None, static_arp_entries=None, name=None, ip_addresses=None, links=None, id=None, _configuration=None):  # noqa: E501
