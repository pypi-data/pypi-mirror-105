...
'''<------------Word2Vec model path------------------------------>'''
word2vec_model_sm_path = os.path.join(root_dir,'word2vec/models','sabda_to_vec_model')
word2vec_model_md_path = os.path.join(root_dir,"word2vec/models","sabda_to_vec_model_md")
