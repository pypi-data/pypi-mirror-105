...
class AipOcr(AipBase):
    ...
    def docAnalysisUrl(self, url, options=None):
        ...
        return self._request(self.__doc_analysisUrl, data)
    ...
    def vehicleInvoiceUrl(self, url, options=None):
        ...
        return self._request(self.__vehicle_invoiceUrl, data)
    ...
    def vehicleCertificateUrl(self, url, options=None):
        ...
        return self._request(self.__vehicle_certificateUrl, data)
    ...
    def householdRegisterUrl(self, url, options=None):
        ...
        return self._request(self.__household_registerUrl, data)
    ...
    def airTicketUrl(self, url, options=None):
        ...
        return self._request(self.__air_ticketUrl, data)
