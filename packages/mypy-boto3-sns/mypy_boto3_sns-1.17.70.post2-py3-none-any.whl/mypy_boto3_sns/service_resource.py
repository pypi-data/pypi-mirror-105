...
class PlatformEndpoint(Boto3ServiceResource):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.70/reference/services/sns.html#SNS.ServiceResource.PlatformEndpoint)[Show boto3-stubs documentation](./service_resource.md#platformendpoint)
    """
...
class Subscription(Boto3ServiceResource):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.70/reference/services/sns.html#SNS.ServiceResource.Subscription)[Show boto3-stubs documentation](./service_resource.md#subscription)
    """
...
class PlatformApplication(Boto3ServiceResource):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.70/reference/services/sns.html#SNS.ServiceResource.PlatformApplication)[Show boto3-stubs documentation](./service_resource.md#platformapplication)
    """
...
class Topic(Boto3ServiceResource):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.70/reference/services/sns.html#SNS.ServiceResource.Topic)[Show boto3-stubs documentation](./service_resource.md#topic)
    """
...
class SNSServiceResource(Boto3ServiceResource):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.70/reference/services/sns.html#SNS.ServiceResource)[Show boto3-stubs documentation](./service_resource.md)
    """
