...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', '3.1.0-alpha.1620806647+3b9d532b'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud 3.1.0-alpha.1620806647+3b9d532b`
                """)
            else:
                raise
