...
class Vision:
    ...
    def find_face_blockly(self, frame, bounding_box=True, scale_factor=1.05, min_neighbors=8, min_size=(40, 40),
                  max_size=(320, 320)):
        """
        finds a face in a given frame, the frames must be gray scaled.
        will draw a bounding box around the face, will be drawn on grayscale image
    ...
    def find_stop_sign_blockly(self, frame, bounding_box=True, scale_factor=1.05, min_neighbors=8, min_size=(40, 40),
                  max_size=(320, 320)):
        """
        finds a face in a given frame, the frames must be gray scaled.
        will draw a bounding box around the face, will be drawn on grayscale image
