...
@click.option('--site_id', type=str,
              help='''Assurance site UUID.''',
              show_default=True)
@click.option('--start_time', type=int,
              help='''The epoch time in milliseconds.''',
              show_default=True)
@click.option('--end_time', type=int,
              help='''The epoch time in milliseconds.''',
              show_default=True)
@click.option('--test_failure_by', type=str,
              help='''Obtain failure statistics group by "area", "building", or "floor".''',
              show_default=True)
@click.option('--headers', type=str, help='''Dictionary of HTTP Headers to send with the Request.''',
              default=None,
              show_default=True)
...
@click.option('--beep', is_flag=True, help='''Spinner beep (on)''')
@click.pass_obj
def sensor_test_results(obj, pretty_print, beep,
                        site_id,
                        start_time,
                        end_time,
                        test_failure_by,
    ...
    try:
        if headers is not None:
            headers = json.loads(headers)
        result = obj.sensor_test_results(
            site_id=site_id,
