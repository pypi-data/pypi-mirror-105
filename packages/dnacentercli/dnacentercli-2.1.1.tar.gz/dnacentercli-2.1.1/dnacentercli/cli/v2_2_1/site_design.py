...
@click.option('--device', type=str, multiple=True,
              help='''Device details array, property of the request body (list of objects).''',
              default=None,
              show_default=True)
...
@click.option('--provisioning', type=str, multiple=True,
              help='''Provisioning details array, property of the request body (list of objects).''',
              default=None,
              show_default=True)
@click.option('--siteprofile', type=str, multiple=True,
              help='''Site profile details array, property of the request body (list of objects).''',
              default=None,
              show_default=True)
@click.option('--headers', type=str, help='''Dictionary of HTTP Headers to send with the Request.''',
              default=None,
...
@click.option('--profilename', type=str,
              help='''Name of the profile to create NFV profile, property of the request body.''',
              default=None,
              show_default=True)
@click.option('--headers', type=str, help='''Dictionary of HTTP Headers to send with the Request.''',
              default=None,
