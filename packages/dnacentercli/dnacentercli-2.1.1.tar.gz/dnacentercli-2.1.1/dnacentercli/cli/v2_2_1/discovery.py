...
@click.option('--discoverytype', type=str,
              help='''InventoryRequest's Type of Discovery. 'SINGLE', 'RANGE', 'MULTI RANGE', 'CDP', 'LLDP'.''',
              default=None,
              show_default=True)
@click.option('--enablepasswordlist', type=str, multiple=True,
              help='''InventoryRequest's Enable Password of the devices to be discovered (list of string, objects).''',
              default=None,
              show_default=True)
@click.option('--globalcredentialidlist', type=str, multiple=True,
              help='''InventoryRequest's Global Credential Ids to be used for discovery (list of string, objects).''',
              default=None,
              show_default=True)
@click.option('--httpreadcredential', type=str,
              help='''InventoryRequest's HTTP Read Credential of the devices to be discovered.''',
              default=None,
              show_default=True)
@click.option('--httpwritecredential', type=str,
              help='''InventoryRequest's HTTP Write Credential of the devices to be discovered.''',
              default=None,
              show_default=True)
@click.option('--ipaddresslist', type=str,
              help='''InventoryRequest's IP Address of devices to be discovered. Ex'172.30.0.1' for SINGLE, CDP and LLDP; '72.30.0.1-172.30.0.4' for RANGE; '72.30.0.1-172.30.0.4,172.31.0.1-172.31.0.4' for MULTI RANGE.''',
              default=None,
              show_default=True)
@click.option('--ipfilterlist', type=str, multiple=True,
              help='''InventoryRequest's IP Addresses of the devices to be filtered out during discovery (list of string, objects).''',
              default=None,
              show_default=True)
...
@click.option('--name', type=str,
              help='''InventoryRequest's Name of the discovery.''',
              default=None,
              show_default=True)
@click.option('--netconfport', type=str,
              help='''InventoryRequest's Netconf Port. It will need valid SSH credentials to work.''',
              default=None,
              show_default=True)
@click.option('--passwordlist', type=str, multiple=True,
              help='''InventoryRequest's Password of the devices to be discovered (list of string, objects).''',
              default=None,
              show_default=True)
@click.option('--preferredmgmtipmethod', type=str,
              help='''InventoryRequest's Preferred Management IP Method.'None' or 'UseLoopBack'. Default is 'None'.''',
              default=None,
              show_default=True)
@click.option('--protocolorder', type=str,
              help='''InventoryRequest's Order of protocol (ssh/telnet) in which device connection will be tried. Ex'telnet'only telnet; 'ssh,telnet'ssh with higher order than telnet.''',
              default=None,
              show_default=True)
...
@click.option('--snmpauthpassphrase', type=str,
              help='''InventoryRequest's Auth Pass phrase for SNMP.''',
              default=None,
              show_default=True)
@click.option('--snmpauthprotocol', type=str,
              help='''InventoryRequest's SNMP auth protocol. SHA' or 'MD5'.''',
              default=None,
              show_default=True)
@click.option('--snmpmode', type=str,
              help='''InventoryRequest's Mode of SNMP. 'AUTHPRIV' or 'AUTHNOPRIV' or 'NOAUTHNOPRIV'.''',
              default=None,
              show_default=True)
@click.option('--snmpprivpassphrase', type=str,
              help='''InventoryRequest's Pass phrase for SNMP privacy.''',
              default=None,
              show_default=True)
@click.option('--snmpprivprotocol', type=str,
              help='''InventoryRequest's SNMP privacy protocol. 'DES' or 'AES128'.''',
              default=None,
              show_default=True)
@click.option('--snmprocommunity', type=str,
              help='''InventoryRequest's Snmp RO community of the devices to be discovered.''',
              default=None,
              show_default=True)
@click.option('--snmprocommunitydesc', type=str,
              help='''InventoryRequest's Description for Snmp RO community.''',
              default=None,
              show_default=True)
@click.option('--snmprwcommunity', type=str,
              help='''InventoryRequest's Snmp RW community of the devices to be discovered.''',
              default=None,
              show_default=True)
@click.option('--snmprwcommunitydesc', type=str,
              help='''InventoryRequest's Description for Snmp RW community.''',
              default=None,
              show_default=True)
@click.option('--snmpusername', type=str,
              help='''InventoryRequest's SNMP username of the device.''',
              default=None,
              show_default=True)
@click.option('--snmpversion', type=str,
              help='''InventoryRequest's Version of SNMP. v2 or v3.''',
              default=None,
              show_default=True)
...
@click.option('--usernamelist', type=str, multiple=True,
              help='''InventoryRequest's Username of the devices to be discovered (list of string, objects).''',
              default=None,
              show_default=True)
@click.option('--headers', type=str, help='''Dictionary of HTTP Headers to send with the Request.''',
              default=None,
