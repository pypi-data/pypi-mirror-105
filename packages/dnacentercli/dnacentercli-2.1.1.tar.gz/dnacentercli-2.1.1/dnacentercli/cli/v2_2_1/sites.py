...
@click.option('--device', type=str, multiple=True,
              help='''Device ip array, property of the request body (list of objects).''',
              default=None,
              show_default=True)
...
@click.option('--site', type=str,
              help='''Site details, property of the request body.''',
              default=None,
              show_default=True)
@click.option('--type', type=str,
              help='''Type of site to create (egarea, building, floor), property of the request body. Available values are 'area', 'building' and 'floor'.''',
              default=None,
              show_default=True)
@click.option('--headers', type=str, help='''Dictionary of HTTP Headers to send with the Request.''',
              default=None,
...
@click.option('--limit', type=str,
              ...
              show_default=True)
@click.option('--device_family', type=str,
