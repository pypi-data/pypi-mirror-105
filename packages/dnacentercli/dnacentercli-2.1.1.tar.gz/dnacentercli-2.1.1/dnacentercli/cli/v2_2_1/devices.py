...
@click.option('--module_operationstatecode', type=str,
              ...
              show_default=True)
@click.option('--id', type=str,
              help='''Accepts comma separated ids and return list of network-devices for the given ids. If invalid or not-found ids are provided, null entry will be returned in the list.''',
              show_default=True)
@click.option('--headers', type=str, help='''Dictionary of HTTP Headers to send with the Request.''',
              default=None,
              show_default=True)
...
@click.option('--beep', is_flag=True, help='''Spinner beep (on)''')
@click.pass_obj
def poe_details_(obj, pretty_print, beep,
                 device_uuid,
                 headers):
...
@devices.command()
@click.option('--device_role', type=str,
              help='''The device role (One of CORE, ACCESS, DISTRIBUTION, ROUTER, WLC, AP).''',
              show_default=True)
@click.option('--site_id', type=str,
              help='''Assurance site UUID value.''',
              show_default=True)
@click.option('--health', type=str,
              help='''The device overall health (One of POOR, FAIR, GOOD).''',
              show_default=True)
@click.option('--start_time', type=int,
              help='''UTC epoch time in milliseconds.''',
              show_default=True)
@click.option('--end_time', type=int,
              help='''UTC epoch time in miliseconds.''',
              show_default=True)
@click.option('--limit', type=int,
              help='''Max number of device entries in the response (default to 50.  Max at 1000).''',
              show_default=True)
@click.option('--offset', type=int,
              help='''The offset of the first device in the returned data.''',
              show_default=True)
@click.option('--headers', type=str, help='''Dictionary of HTTP Headers to send with the Request.''',
              default=None,
              show_default=True)
...
@click.option('--beep', is_flag=True, help='''Spinner beep (on)''')
@click.pass_obj
def devices(obj, pretty_print, beep,
            device_role,
            site_id,
            health,
            start_time,
...
@click.option('--endtime', type=int,
              help='''Threat Parameters's endTime.''',
              default=None,
              show_default=True)
@click.option('--isnewthreat', type=bool,
              help='''Threat Parameters's isNewThreat.''',
              default=None,
              show_default=True)
@click.option('--limit', type=int,
              help='''Threat Parameters's limit.''',
              default=None,
              show_default=True)
@click.option('--offset', type=int,
              help='''Threat Parameters's offset.''',
              default=None,
              show_default=True)
@click.option('--siteid', type=str, multiple=True,
              help='''Threat Parameters's Site Id (list of strings).''',
              default=None,
              show_default=True)
@click.option('--starttime', type=int,
              help='''Threat Parameters's startTime.''',
              default=None,
              show_default=True)
@click.option('--threatlevel', type=str, multiple=True,
              help='''Threat Parameters's Threat Level (list of strings).''',
              default=None,
              show_default=True)
@click.option('--threattype', type=str, multiple=True,
              help='''Threat Parameters's Threat Type (list of strings).''',
              default=None,
              show_default=True)
@click.option('--headers', type=str, help='''Dictionary of HTTP Headers to send with the Request.''',
              default=None,
...
@click.option('--beep', is_flag=True, help='''Spinner beep (on)''')
@click.pass_obj
def threat_details(obj, pretty_print, beep,
                   endtime,
                   isnewthreat,
                   limit,
                   offset,
    ...
    try:
        ...
        if payload is not None:
            payload = json.loads(payload)
        siteid = list(siteid)
        siteid = siteid if len(siteid) > 0 else None
        threatlevel = list(threatlevel)
        threatlevel = threatlevel if len(threatlevel) > 0 else None
        threattype = list(threattype)
        threattype = threattype if len(threattype) > 0 else None
        result = obj.threat_details(
            endTime=endtime,
...
@devices.command()
@click.option('--endtime', type=int,
              help='''endTime, property of the request body.''',
              default=None,
              show_default=True)
@click.option('--isnewthreat', type=bool,
              help='''isNewThreat, property of the request body.''',
              default=None,
              show_default=True)
@click.option('--limit', type=int,
              help='''limit, property of the request body.''',
              default=None,
              show_default=True)
@click.option('--offset', type=int,
              help='''offset, property of the request body.''',
              default=None,
              show_default=True)
@click.option('--siteid', type=str, multiple=True,
              help='''Site Id, property of the request body (list of strings).''',
              default=None,
              show_default=True)
@click.option('--starttime', type=int,
              help='''startTime, property of the request body.''',
              default=None,
              show_default=True)
@click.option('--threatlevel', type=str, multiple=True,
              help='''Threat Level, property of the request body (list of strings).''',
              default=None,
              show_default=True)
@click.option('--threattype', type=str, multiple=True,
              help='''Threat Type, property of the request body (list of strings).''',
              default=None,
              show_default=True)
@click.option('--headers', type=str, help='''Dictionary of HTTP Headers to send with the Request.''',
              default=None,
...
@click.option('--beep', is_flag=True, help='''Spinner beep (on)''')
@click.pass_obj
def threat_detail_count(obj, pretty_print, beep,
                        endtime,
                        isnewthreat,
                        limit,
                        offset,
    ...
    try:
        ...
        threattype = list(threattype)
        threattype = threattype if len(threattype) > 0 else None
        result = obj.threat_detail_count(
            endTime=endtime,
            isNewThreat=isnewthreat,
            limit=limit,
            offset=offset,
...
@click.option('--beep', is_flag=True, help='''Spinner beep (on)''')
@click.pass_obj
def threat_summary(obj, pretty_print, beep,
                   endtime,
                   siteid,
                   starttime,
                   threatlevel,
