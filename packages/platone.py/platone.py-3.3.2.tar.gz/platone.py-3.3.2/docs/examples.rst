...
``web3.platone.getBlock`` API.  Block hashes should be in their hexadecimal
representation.  Block numbers

.. code-block:: python

    # get a block by number
    >>> web3.platone.getBlock(12345)
    {
    ...
    >>> web3.platone.getBlock('0x767c2bfb3bdee3f78676c1285cd757bcd5d8c272cef2eb30d9733800a78c0b6d')
    {...}
...
``web3.platone.getBlock`` API.

.. code-block:: python

    >>> web3.platone.getBlock('latest')
    {...}


If you want to know the latest block number you can use the
``web3.platone.blockNumber`` property.

.. code-block:: python

    >>> web3.platone.blockNumber
    4194803
...
You can look up transactions using the ``web3.platone.getTransaction`` function.

.. code-block:: python

    >>> web3.platone.getTransaction('0x5c504ed432cb51138bcf09aa5e8a410dd4a1e204ef84bfed1be16dfba1b22060')
    {
...
Transaction receipts can be retrieved using the ``web3.platone.getTransactionReceipt`` API.


.. code-block:: python

    >>> web3.platone.getTransactionReceipt('0x5c504ed432cb51138bcf09aa5e8a410dd4a1e204ef84bfed1be16dfba1b22060')
    {
        'blockHash': '0x4e3a3754410177e6937ef1f84bba68ea139e8d1a2258c5f85db9f1cd715a1bdd',
        'blockNumber': 46147,
...
.. code-block:: python
    ...
    def deploy_contract(w3, contract_interface):
        tx_hash = w3.platone.contract(
            abi=contract_interface['abi'],
            bytecode=contract_interface['bin']).deploy()
    
        address = w3.platone.getTransactionReceipt(tx_hash)['contractAddress']
        return address
    ...
    store_var_contract = w3.platone.contract(
       address=address,
       abi=contract_interface['abi'])
...
.. doctest::
    ...
    >>> import json
        >>> from platone.auto.infura import w3
        ...
        >>> erc20 = w3.platone.contract(address='0x89205A3A3b2A69De6Dbf7f01ED13B2108B2c43e7', abi=ERC20_ABI)
