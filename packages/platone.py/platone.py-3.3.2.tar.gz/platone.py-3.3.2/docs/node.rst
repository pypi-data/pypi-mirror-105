...
you, meaning that some common methods like :meth:`w3.platone.sendTransaction()
<web3.platone.Eth.sendTransaction>` are not directly available. To send transactions
