...
Many of the typical things you'll want to do will be in the :class:`w3.platone <web3.platone.Eth>` API,
...
:meth:`w3.platone.contract() <web3.platone.Eth.contract>`.
