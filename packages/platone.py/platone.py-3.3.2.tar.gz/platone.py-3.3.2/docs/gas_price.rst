...
:meth:`~web3.platone.generateGasPrice`

.. code-block:: python

    >>> web3.platone.generateGasPrice()
    20000000000
...
The gas price strategy can be set by calling :meth:`~web3.platone.setGasPriceStrategy`.
...
.. code-block:: python
    ...
    w3 = Web3(...)
    w3.platone.setGasPriceStrategy(value_based_gas_price_strategy)
...
.. py:method:: construct_time_based_gas_price_strategy(max_wait_seconds, sample_size, probability)
    ...
    * ``web3.gas_strategies.time_based.glacial_gas_price_strategy``: Transaction mined within 24 hours.
    ...
    .. code-block:: python
        ...
        w3 = Web3()
        w3.platone.setGasPriceStrategy(medium_gas_price_strategy)
