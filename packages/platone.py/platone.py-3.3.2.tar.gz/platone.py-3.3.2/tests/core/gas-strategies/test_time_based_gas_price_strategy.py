...
from platone.gas_strategies.time_based import (
    construct_time_based_gas_price_strategy,
)
from platone.middleware import (
    construct_result_generator_middleware,
)
from platone.providers.base import (
    BaseProvider,
)
...
def test_time_based_gas_price_strategy(strategy_params, expected):
    ...
    w3.platone.setGasPriceStrategy(time_based_gas_price_strategy)
    actual = w3.platone.generateGasPrice()
...
def test_time_based_gas_price_strategy_zero_sample(strategy_params_zero,
    ...
    with pytest.raises(ValidationError) as excinfo:
        ...
        w3.platone.setGasPriceStrategy(time_based_gas_price_strategy_zero)
        w3.platone.generateGasPrice()
