...
def test_finds_single_function_without_args(web3):
    Contract = web3.platone.contract(abi=SINGLE_FN_NO_ARGS)
...
def test_finds_single_function_with_args(web3):
    Contract = web3.platone.contract(abi=SINGLE_FN_ONE_ARG)
...
def test_finds_fallback_function(web3):
    Contract = web3.platone.contract(abi=FALLBACK_FUNCTION)
