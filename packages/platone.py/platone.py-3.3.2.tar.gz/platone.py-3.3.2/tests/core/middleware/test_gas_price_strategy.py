...
def test_gas_price_generated(the_gas_price_strategy_middleware):
    the_gas_price_strategy_middleware.web3.platone.generateGasPrice.return_value = 5
    ...
    the_gas_price_strategy_middleware.web3.platone.generateGasPrice.assert_called_once_with({
        'to': '0x0',
        'value': 1,
    })
...
def test_gas_price_not_set_without_gas_price_strategy(the_gas_price_strategy_middleware):
    the_gas_price_strategy_middleware.web3.platone.generateGasPrice.return_value = None
    method = 'platon_sendTransaction'
    params = [{
        'to': '0x0',
        'value': 1,
