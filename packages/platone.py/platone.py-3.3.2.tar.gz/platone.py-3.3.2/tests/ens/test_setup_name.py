...
from platone.packages.ens .main import (
    AddressMismatch,
    UnauthorizedError,
    UnownedName,
)
...
def test_setup_name(ens, name, normalized_name, namehash_hex):
    address = ens.web3.platone.accounts[3]
...
def test_setup_name_default_address(ens):
    ...
    new_resolution = ens.web3.platone.accounts[-1]
...
def test_setup_name_default_to_owner(ens):
    ...
    new_owner = ens.web3.platone.accounts[-1]
