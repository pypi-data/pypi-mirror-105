...
from platone.utils.validation import (
    validate_address,
)
...
class Filter:
    ...
    def get_new_entries(self):
        log_entries = self._filter_valid_entries(self.web3.platone.getFilterChanges(self.filter_id))
        return self._format_log_entries(log_entries)

    def get_all_entries(self):
        log_entries = self._filter_valid_entries(self.web3.platone.getFilterLogs(self.filter_id))
        return self._format_log_entries(log_entries)
