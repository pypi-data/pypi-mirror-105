...
from platone.packages.eth_utils.curried import (
...
from platone.utils.toolz.curried import (
    keymap,
    valmap,
)
...
pythonic_middleware = construct_formatting_middleware(
    request_formatters={
        # Platon
        'platon_getBalance': apply_formatter_at_index(block_number_formatter, 2),
        'platon_getBlockByNumber': apply_formatter_at_index(block_number_formatter, 2),
        'platon_getBlockTransactionCountByNumber': apply_formatter_at_index(
            block_number_formatter,
            1,
        ),
        'platon_getCode': apply_formatter_at_index(block_number_formatter, 2),
        'platon_getStorageAt': apply_formatter_at_index(block_number_formatter, 3),
        ...
        'platon_getTransactionCount': apply_formatter_at_index(block_number_formatter, 2),
        'platon_newFilter': apply_formatter_at_index(filter_params_formatter, 1),
        'platon_getLogs': apply_formatter_at_index(filter_params_formatter, 1),
        'platon_call': combine_argument_formatters(
            # transaction_param_formatter,
            block_number_formatter,
        ),
        'platon_estimateGas': apply_formatter_at_index(transaction_param_formatter, 1),
        'platon_sendTransaction': apply_formatter_at_index(transaction_param_formatter, 1),
        # personal
        'personal_importRawKey': apply_formatter_at_index(
            compose(remove_0x_prefix, hexstr_if_str(to_hex)),
            1,
        ),
        'personal_sign': apply_formatter_at_index(text_if_str(to_hex), 1),
        'personal_ecRecover': apply_formatter_at_index(text_if_str(to_hex), 1),
        'personal_sendTransaction': apply_formatter_at_index(transaction_param_formatter, 1),
        # Snapshot and Revert
        'evm_revert': apply_formatter_at_index(integer_to_hex, 1),
        'trace_replayBlockTransactions': apply_formatter_at_index(block_number_formatter, 1),
        'trace_block': apply_formatter_at_index(block_number_formatter, 1),
        'trace_call': compose(
            apply_formatter_at_index(transaction_param_formatter, 1),
            apply_formatter_at_index(block_number_formatter, 3)
        ),
    },
    result_formatters={
        # Eth
