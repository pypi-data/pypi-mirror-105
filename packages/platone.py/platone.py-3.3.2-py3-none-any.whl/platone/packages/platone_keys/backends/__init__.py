...
from platone.packages.platone_keys.utils.module_loading import (
    import_string,
)
...
def get_default_backend_class() -> str:
    if is_coincurve_available():
        return 'platone.packages.platone_keys.backends.CoinCurveECCBackend'
    else:
        return 'platone.packages.platone_keys.backends.NativeECCBackend'
