...
from platone.packages.platone_keyfile import (
    create_keyfile_json,
    decode_keyfile_json,
)
from platone.packages.platone_keys import (
    KeyAPI,
    keys,
)
...
from platone.packages.platone_account.datastructures import (
    AttributeDict,
)
...
from platone.packages.platone_account.internal.transactions import (
    Transaction,
    vrs_from,
)
from platone.packages.platone_account.signers.local import (
    LocalAccount,
)
...
class Account(object):
    ...
    def signHash(self, message_hash, private_key, mode='ECDSA'):
        ...
        :meth:`w3.platone.sign() <web3.platone.Eth.sign>`
        ...
        .. code-block:: python
            ...
            >>> msg = "I♥SF"
            >>> from platone.packages.platone_account.messages import defunct_hash_message
    ...
    def signTransaction(self, transaction_dict, private_key, net_type=MIANNETHRP, mode='ECDSA'):
        ...
        :meth:`w3.platone.sendRawTransaction() <web3.platone.Eth.sendRawTransaction>`.
        ...
        .. code-block:: python
            ...
            {'hash': HexBytes('0x6893a6ee8df79b0f5d64a180cd1ef35d030f3e296a5361cf04d02ce720d32ec5'),
             ...
             'v': 37}
            >>> w3.platone.sendRawTransaction(signed.rawTransaction)
        '''
