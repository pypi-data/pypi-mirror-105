...
from platone.middleware.formatting import (
...
def transaction_param_validator(web3):
    transactions_params_validators = {
        'chainId': apply_formatter_if(
            ...
            lambda _: is_not_null(web3.chainId),
...
def chain_id_validator(web3):
    return compose(
        apply_formatter_at_index(transaction_normalizer, 1),
