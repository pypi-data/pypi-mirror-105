...
geolayer_fields_with_bytes_values = {
    "metadata": {
        ...
        "fields": {
            ...
            "field_hexa_a": {"type": "String", "width": 1116, "index": 1},
    ...
    "features": {
        0: feature_attributes_bytes_only_a,
        1: {
            "attributes": {
                "field_bytes": None,
...
geolayer_fields_with_bytes_values_forced = {
    "metadata": {
        ...
        "fields": {
            ...
            "field_hexa_b": {"type": "String", "width": 1116, "index": 2},
            "field_bytes_hexa_a": {"type": "Binary", "index": 3},
            "field_bytes_hexa_b": {"type": "String", "width": 1116, "index": 4},
        },
    },
    "features": {
        0: {
            "attributes": {
                ...
                "field_bytes_hexa_a": bytes.fromhex(POINT_WKB_HEX_BIG_ENDIAN),
...
feature_list_data_and_geometry_geolayer = {
    "metadata": {
        ...
        "fields": geolayer_data_fields_metadata_extract,
        "geometry_ref": {"type": {"Polygon", "MultiPolygon"}, "crs": 2154},
    },
    "features": {
        0: feature_dpt_data_and_geometry_a,
        1: feature_dpt_data_and_geometry_b,
        2: feature_dpt_data_and_geometry_c,
        3: feature_dpt_data_and_geometry_d,
    },
}
...
feature_list_data_and_geometry_serialized_geolayer = {
    ...
    "features": {
        0: feature_dpt_data_and_geometry_a_serialized,
        1: feature_dpt_data_and_geometry_b_serialized,
        2: feature_dpt_data_and_geometry_c_serialized,
        3: feature_dpt_data_and_geometry_d_serialized,
    },
}

geolayer_for_index = {
    "metadata": {"geometry_ref": {"type": "Polygon"}, "name": "geolayer_for_index"},
    "features": {
        0: {
            "geometry": {
                "type": "Polygon",
                "coordinates": [
                    ((3.78, 10.0), (-14.0, 1.52), (3.78, 6.5), (8.0, 3.0), (3.78, 10.0))
                ],
            }
        },
        1: {
            "geometry": {
                "type": "Polygon",
                "coordinates": [((3.0, 3.0), (8.0, -2.0), (-3.0, -3.0), (3.0, 3.0))],
            }
        },
        2: {
            "geometry": {
                "type": "Polygon",
                "coordinates": [
                    ((-13.28, -5.0), (-9.0, -2.2), (-1.0, -8.0), (-13.28, -5.0))
                ],
            }
        },
    },
    ...
    "features": {
        0: {
            "geometry": {
                "type": "LineString",
                "coordinates": [
                    [167952.16853944218, 5388680.860679348],
                    [167972.2060477877, 5388818.984447511],
                ],
            }
        }
    },
...
geolayer_for_index_height = {
    "metadata": {
        "geometry_ref": {"type": "LineString"},
        "name": "geolayer_for_index_height",
    },
    "features": {
        0: {
            "geometry": {
                "type": "LineString",
                "coordinates": [
                    [168420.82359568248, 5386574.910679045],
                    [168474.70014136125, 5386578.5641577],
                ],
            }
        }
    },
...
geolayer_for_index_width_height = {
    "metadata": {
        "geometry_ref": {"type": "LineString"},
        "name": "geolayer_for_index_width_height",
    },
    "features": {
        0: {
            "geometry": {
                "type": "LineString",
                "coordinates": [
                    [168148.09084323974, 5388941.762858973],
                    [169325.85105583287, 5387529.909342526],
                ],
            }
        }
    },
...
geolayer_for_index_border_width_height = {
    "metadata": {
        "geometry_ref": {"type": "LineString"},
        "name": "geolayer_for_index_border_width_height",
    },
    "features": {
        0: {"geometry": {"type": "LineString", "coordinates": [[0, 0], [-30, -30]]}}
    },
}
...
geolayer_grid_3_3 = {
    "metadata": {
        ...
        "fields": {"g_id": {"type": "String", "width": 254, "index": 0}},
    },
    "features": {
        0: {
            "attributes": {"g_id": (0, 0)},
        ...
        1: {
            ...
            "geometry": {
                "type": "Polygon",
                "coordinates": [
                    [[0.0, 3.0], [0.0, 6.0], [3.0, 6.0], [3.0, 3.0], [0.0, 3.0]]
                ],
            },
        },
        2: {
            ...
            "geometry": {
                "type": "Polygon",
                "coordinates": [
                    [[0.0, 6.0], [0.0, 9.0], [3.0, 9.0], [3.0, 6.0], [0.0, 6.0]]
                ],
            },
        },
        3: {
            ...
            "geometry": {
                "type": "Polygon",
                "coordinates": [
                    [[3.0, 0.0], [3.0, 3.0], [6.0, 3.0], [6.0, 0.0], [3.0, 0.0]]
                ],
            },
        },
        4: {
        ...
        5: {
            ...
            "geometry": {
                "type": "Polygon",
                "coordinates": [
                    [[3.0, 6.0], [3.0, 9.0], [6.0, 9.0], [6.0, 6.0], [3.0, 6.0]]
                ],
            },
        },
        6: {
            ...
            "geometry": {
                "type": "Polygon",
                "coordinates": [
                    [[6.0, 0.0], [6.0, 3.0], [9.0, 3.0], [9.0, 0.0], [6.0, 0.0]]
                ],
            },
        },
        7: {
            ...
            "geometry": {
                "type": "Polygon",
                "coordinates": [
                    [[6.0, 3.0], [6.0, 6.0], [9.0, 6.0], [9.0, 3.0], [6.0, 3.0]]
                ],
            },
        },
        8: {
...
if __name__ == '__main__':
    geolayer_attributes_only_features_list = [feature for i_feat, feature in geolayer_attributes_only["features"].items()]
    print(geolayer_attributes_only_features_list)
    from geoformat import feature_list_to_geolayer
    geolayer_attributes_only_clean = feature_list_to_geolayer(feature_list=geolayer_attributes_only_features_list, geolayer_name=geolayer_attributes_only['metadata']['name'])

    print(geolayer_attributes_only_clean['metadata']['fields'])