...
class DependencyMixin:
    ...
    def _check_dependency_listing(self):
        ...
        message = f"""
        {warning_str}
        No requirements.txt or environment.yml found or incomplete. 
        Your build could crash or not start.
        What do you want to do?

        [1] I don't care, continue to run
        [2] make me a requirements.txt file!
        [3] I'll make my requirements.txt file (Exit)

        You can use the flag --ignore_warnings to skip this warning.
        """
        user_choice = "1"  # Ignore and continue to train
        ...
        return user_choice == "2"  # skipcq: PYL-R1719
