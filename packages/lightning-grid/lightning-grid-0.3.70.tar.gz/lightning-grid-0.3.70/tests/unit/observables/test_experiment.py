...
class TestExperimentObservable:
    ...
    def test_get(self, capsys):
        obsevable = experiment_observable.Experiment(client=self.grid.client, identifier='test-experiment')
    ...
    def test_get_history(self, capsys):
        obsevable = experiment_observable.Experiment(client=self.grid.client, identifier='test-run')
    ...
    def test_render_no_expriment(self):
        ...
        assert [x.header for x in table.columns] == ["Experiment", "Command", "Status", "Duration"]

    def test_render_no_hparam_expriment(self):
        obsevable = experiment_observable.Experiment(client=self.grid.client, identifier='test-run')
        table = obsevable.render_experiments([{
            'experimentId': 'test',
            'name': 'gentle-grasshopper-960-exp0',
            'status': 'succeeded',
            'invocationCommands': 'python pl_mnist.py',
            'createdAt': '2020-11-16T21:01:29.813309+00:00',
            'finishedAt': '2020-11-16T21:44:05+00:00',
            'commitSha': 'e2f16c5c14d52c332568718bfef9f632e3191825',
            'run': {
                'runId': '34dfb18f-d64b-4a67-ac68-773022a81996'
            },
            'startedRunningAt': '2020-11-16T21:18:45+00:00'
        }])
    ...
    def test_render_hparam_expriment(self):
        ...
        table = obsevable.render_experiments([{
            ...
            'name': 'gentle-grasshopper-960-exp0',
            'status': 'succeeded',
            'invocationCommands': 'python pl_mnist.py --lr 0.5',
            'createdAt': '2020-11-16T21:01:29.813309+00:00',
            'finishedAt': '2020-11-16T21:44:05+00:00',
            'commitSha': 'e2f16c5c14d52c332568718bfef9f632e3191825',
            'run': {
        ...
        assert table.row_count == 1
        assert [x.header for x in table.columns] == ["Experiment", "Command", "Status", "Duration", "lr"]
        assert [x._cells[0] for x in table.columns] == [
            'gentle-grasshopper-960-exp0',
            'pl_mnist.py',
            'succeeded',
