...
setup(
  name='Toncalculator',
  version='0.0.4',
  description='A basic scientific calculator',
  ...
  keywords='calculator toncalculator add addison subdivision log sin cos tan cat, sce cosec a simple calculator fine calculator terminal calculator', # used when people are searching for a module, keywords separated with a space
