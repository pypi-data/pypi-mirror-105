...
class SupplyCollection(SalesInvBase):
    ...
    def getInstance(cls,docRef):
        with lock:
            if SupplyCollection.__instance == None:
                ...
                SupplyCollection.__instance = SupplyCollection(SupplyCollection.get_firestore_client(),**docDict)
            return SupplyCollection.__instance
