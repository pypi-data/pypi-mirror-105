...
class NotesCollection(SalesInvBase):
    ...
    def getInstance(cls,docRef):
        with lock:
            if NotesCollection.__instance == None:
                ...
                NotesCollection.__instance = NotesCollection(NotesCollection.get_firestore_client(),**docDict)
            return NotesCollection.__instance
