...
class ItemWeek(SalesInvBase):
    ...
    ext_fields = ['item','name','item_name','item_type','item_id','finish_week','actual','want_qty','total_reserved','total_forecasted','color_groupings','groupings','inventory_location','soft_delete','parent_path','path']
    COLLECTION_NAME = 'application_data'
    ...
    def __init__(self, fsClient, **kwargs):
        ...
        self.total_reserved = kwargs.get('total_reserved',None)
