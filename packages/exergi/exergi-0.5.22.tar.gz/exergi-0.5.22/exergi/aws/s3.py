...
def extract_data_glue(start_date:str, end_date:str, taglist:list, s3_prefix:str):
    ''' Extract pratitioned data using glue job job prod-spark-custom-etl-basic.
    Keyword Arguments:
    ...
    logger.info(f"Extracting Compis data between {start_date} and {end_date}")
