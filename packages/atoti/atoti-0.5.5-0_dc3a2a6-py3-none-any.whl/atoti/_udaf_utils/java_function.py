...
from .utils import TYPE_CONSTRAINTS, get_java_type, simplify_java_type
...
class ExistingJavaFunction(JavaFunction):
    ...
    def _get_output_type_function(
        ...
        def output_type_function(
            ...
            java_types = [
                JAVA_TYPES[simplify_java_type(operation_element.output_type.java_type)]
...
def is_signature_valid(
    ...
    for signature in signatures:
        ...
        if all(
            [
                simplify_java_type(operationElement.output_type.java_type)
