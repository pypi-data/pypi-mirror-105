    ...
    def create_session(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            config: The session configuration regrouping all the aspects of the session that might change depending on where it is deployed.
        ...
        full_config = merged_config._complete_with_default()
