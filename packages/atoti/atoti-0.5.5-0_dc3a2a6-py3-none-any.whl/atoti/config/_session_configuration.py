    ...
    *,
    ...
    Args:
        ...
        same_site:
            ...
            The value to use for the `SameSite <https://web.dev/samesite-cookies-explained/>`__ attribute of the HTTP cookie sent by the session when *authentication* is configured.
