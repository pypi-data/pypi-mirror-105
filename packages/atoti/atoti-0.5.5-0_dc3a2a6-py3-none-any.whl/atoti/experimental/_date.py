...
def create_date_hierarchy(  # pylint: disable=dangerous-default-value
    ...
    *,
    ...
    Supported patterns are the ones of the `DateTimeFormatter in Java <https://docs.oracle.com/en/java/javase/15/docs/api/java.base/java/time/format/DateTimeFormatter.html>`__.
