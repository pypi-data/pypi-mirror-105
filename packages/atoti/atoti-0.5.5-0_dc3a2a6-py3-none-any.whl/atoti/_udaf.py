...
class UserDefinedAggregateFunction:
    ...
    def register_aggregation_function(self):
        ...
        if visitor_class is None:
            raise ValueError("Unsupported aggregation function " + self._agg_fun)
        visitor: OperationVisitor = visitor_class(
