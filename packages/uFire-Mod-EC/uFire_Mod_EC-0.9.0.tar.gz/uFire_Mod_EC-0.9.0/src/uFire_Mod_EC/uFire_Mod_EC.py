...
class i2c(object):
    ...
    @exception_catch
    def measureFreshwater(self, tempC = 25.0, tempCoef = 0.019, tempConst = 25.0, k = 1.0, blocking = True):
        self.measureEC(tempC, tempCoef, tempConst, k, 0, blocking)

        return self.PSU;

    @exception_catch
    def measureSeawater(self, tempC = 25.0, tempCoef = 0.021, tempConst = 25.0, k = 10.0, kPa = 0, blocking = True):
        self.measureEC(tempC, tempCoef, tempConst, k, kPa, blocking)

        return self.PSU;

    @exception_catch
    def measurePurewater(self, tempC = 25.0, tempCoef = 0.019, tempConst = 25.0, k = 0.1, blocking = True):
        self.measureEC(tempC, tempCoef, tempConst, k, 0, blocking)
