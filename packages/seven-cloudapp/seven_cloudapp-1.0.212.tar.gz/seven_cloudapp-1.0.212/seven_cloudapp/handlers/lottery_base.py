...
:LastEditTime: 2021-04-19 14:17:52
...
class LotteryBaseHandler(SevenBaseHandler):
    ...
    def start_turntable(self, app_id, open_id, act_id, login_token):
        ...
        try:
            ...
            if prize_roster.prize_type == 3:
                prize_roster.coupon_type = result_prize["coupon_type"] if result_prize["coupon_type"] else 0
                prize_roster.right_ename = result_prize["right_ename"] if result_prize["right_ename"] else ""
