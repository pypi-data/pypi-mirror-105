...
class IoTJobsDataPlaneClient:
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.68/reference/services/iot-jobs-data.html#IoTJobsDataPlane.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.68/reference/services/iot-jobs-data.html#IoTJobsDataPlane.Client.can_paginate)
    ...
    def describe_job_execution(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.68/reference/services/iot-jobs-data.html#IoTJobsDataPlane.Client.describe_job_execution)
    ...
    def generate_presigned_url(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.68/reference/services/iot-jobs-data.html#IoTJobsDataPlane.Client.generate_presigned_url)
    ...
    def get_pending_job_executions(self, thingName: str) -> GetPendingJobExecutionsResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.68/reference/services/iot-jobs-data.html#IoTJobsDataPlane.Client.get_pending_job_executions)
    ...
    def start_next_pending_job_execution(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.68/reference/services/iot-jobs-data.html#IoTJobsDataPlane.Client.start_next_pending_job_execution)
    ...
    def update_job_execution(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.68/reference/services/iot-jobs-data.html#IoTJobsDataPlane.Client.update_job_execution)
