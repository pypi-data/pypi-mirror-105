...
from .channel import Author, Channel
...
RENDERER_PARSER = {
    "videoRenderer": lambda x: Video(
        ...
        author=Author(
            x["ownerText"]["runs"][0]["text"],
            x["ownerText"]["runs"][0]["navigationEndpoint"]["commandMetadata"]["webCommandMetadata"]["url"],
            x["ownerText"]["runs"][0]["navigationEndpoint"]["browseEndpoint"]["browseId"]
        ),
        builtin_called=True
    ),
    "radioRenderer": Mix,
    ...
    "promotedVideoRenderer": lambda x: Video(
        ...
        author = Author(
            x["longBylineText"]["runs"][0]["text"],
            x["longBylineText"]["runs"][0]["navigationEndpoint"]["commandMetadata"]["webCommandMetadata"]["url"],
            x["longBylineText"]["runs"][0]["navigationEndpoint"]["browseEndpoint"]["browseId"]
        ),
        builtin_called=True
    ),
