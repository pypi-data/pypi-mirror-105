...
const DocumentationListContent = (
    ...
    return (
        <React.Fragment>
            <button className='blue-button txt-16' onClick={() => {props.setCurrOpenTaskpane({type: TaskpaneType.FEEDBACK, openLocation: FeedbackOpenLocation.FROM_DOCUMENTATION})}}>Provide Feedback</button> 
            <div className='documentation-taskpane-content-function-list-title mt-10px'>
                Basic Examples
            </div>
