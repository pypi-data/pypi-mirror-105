...
class ResourceRecordSetsChangedWaiter(Boto3Waiter):
    ...
    def wait(self, Id: str, WaiterConfig: WaiterConfigTypeDef = None) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.72/reference/services/route53.html#Route53.Waiter.ResourceRecordSetsChangedWaiter)
