...
class Connection(object):
    ...
    def cursor(self, *args, **kwargs):
        ...
        _logger.info("got connection objects {conn} and {conn1}".format(conn=args, conn1= kwargs))
...
class Cursor(common.DBAPICursor):
    ...
    def execute(self, operation, parameters=None, **kwargs):
        ...
        sqlJson = {"sqlQuery": sql, "isPlain": True, "planUuid": self._plan_uuid}
        ...
        resp = response.read()
        print("got response from server ".format(resp))
        responseDict = json.loads(resp)
        return responseDict
    ...
    def get_view_names(self):
        ...
        for item in responseDict:
            ...
            listOfViews.append(item['planName']+":"+item['planUUID'])
        return listOfViews
