...
from ..common import (ChatbotType, MessageType, Platform, WaterfallMode,
                      WhatsappContentType)
...
class Task:
    ...
    def __init__(self, name: str,
                       ...
                       event_id: str = "",
                       chatbot_type: ChatbotType = ChatbotType.NONE,
                       whatsapp_content_type: WhatsappContentType = WhatsappContentType.HSM,
                       message_id: str = "",
                       extra_params: str = ""):
        """
        Parameters:
        ...
        self._task.chatbotType = chatbot_type
        self._task.whatsappContentType = whatsapp_content_type
        self._task.messageID = message_id
        self._task.extraParams = extra_params
