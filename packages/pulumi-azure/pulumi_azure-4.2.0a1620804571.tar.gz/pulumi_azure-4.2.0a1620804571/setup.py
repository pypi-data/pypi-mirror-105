...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '4.2.0-alpha.1620804571+419a6e4f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 4.2.0-alpha.1620804571+419a6e4f`
                """)
            else:
                raise
