...
class SearchDevicesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.70/reference/services/braket.html#Braket.Paginator.SearchDevices.paginate)
...
class SearchQuantumTasksPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.70/reference/services/braket.html#Braket.Paginator.SearchQuantumTasks.paginate)
