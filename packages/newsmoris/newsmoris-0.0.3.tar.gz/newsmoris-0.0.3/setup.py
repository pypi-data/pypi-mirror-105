...
setup(
    ...
    description='Package to get news from various news site in Mauritius',  # Optional
    ...
    url='https://github.com/Abdur-RahmaanJ/newsmoris',  # Optional
    ...
    keywords='mauritius news',  # Optional
    ...
    entry_points={"console_scripts": ["newsmoris=newsmoris.__main__:main"]},
)