...
def get_post(href: str, session: requests.sessions.Session, full: bool = False) -> dict:
...
async def get_post_async(href: str, session: aiohttp.client.ClientSession, full: bool = False):
