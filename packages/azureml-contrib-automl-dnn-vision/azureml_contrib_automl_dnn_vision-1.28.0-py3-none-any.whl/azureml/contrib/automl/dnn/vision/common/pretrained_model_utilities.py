...
class PretrainedModelFactory:
    ...
    @staticmethod
    def _setup_resnet_fpn_backbone_model(model_constructor, pretrained_model_name,
                                         backbone_name, pretrained, progress, num_classes,
                                         pretrained_backbone, load_pretrained_model_dict, strict,
