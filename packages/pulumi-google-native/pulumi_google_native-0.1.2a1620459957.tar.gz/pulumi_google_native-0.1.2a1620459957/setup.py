...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'google-native', '0.1.2a1620459957'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource google-native 0.1.2a1620459957`
                """)
            else:
                raise
