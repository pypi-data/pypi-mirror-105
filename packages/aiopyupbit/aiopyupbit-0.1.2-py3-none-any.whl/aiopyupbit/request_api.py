...
async def _call_public_api(url: str, **kwargs):
    ...
    try:
        async with aiohttp.ClientSession() as session:
            ...
            return await response.json(), remaining_req_dict
...
async def _send_post_request(url: str, headers=None, data=None):
    """
    :param url:
    :param headers:
    :param data:
...
async def _send_get_request(url: str, headers=None, data=None):
    """
    :param url:
    :param headers:
    :return:
...
async def _send_delete_request(url: str, headers=None, data=None):
    """
