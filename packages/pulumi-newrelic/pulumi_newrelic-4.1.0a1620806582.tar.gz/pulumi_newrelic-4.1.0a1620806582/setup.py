...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'newrelic', '4.1.0-alpha.1620806582+417681e6'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource newrelic 4.1.0-alpha.1620806582+417681e6`
                """)
            else:
                raise
