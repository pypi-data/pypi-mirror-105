...
- `misty2py.utils.messages` - contains message parsing methods `message_parser` and `compose_str`.
...
- `free_memory` - a skill that removes non-system audio, video, image and recording files from Misty's memory.
