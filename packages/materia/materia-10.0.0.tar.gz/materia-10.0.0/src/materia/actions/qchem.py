...
class QChemIncreaseResponseIterations(Modify):
    ...
    def modify(self, task):
        try:
            ...
            task.settings["response", "maxiter"] = 60 * self.increase_factor
            # FIXME: 60 is the default value in QChem v5.2.1
            # can this be changed to be version-independent?
...
class QChemIncreaseSCFIterations(Modify):
    ...
    def modify(self, task):
        try:
            ...
            task.settings["rem", "max_scf_cycles"] = 50 * self.increase_factor
            # FIXME: 50 is the default value in QChem v5.2.1
            # can this be changed to be version-independent?
