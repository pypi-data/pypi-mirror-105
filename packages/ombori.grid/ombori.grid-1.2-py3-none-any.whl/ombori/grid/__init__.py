...
class Module:
    ...
    def get_connect_options(self):
        ...
        password = self.get_module_token(3600)
    ...
    def on_settings(self, cb):
        def handler(topic, payload):
            ...
            cb(data)
        self.subscribe("$iothub/twin/PATCH/properties/desired/+", handler)
    ...
    async def get_twin(self):
        ...
        self.client.publish(f"$iothub/twin/GET/?$rid={id}", "")
    ...
    def on_method(self, name: str, cb):
        ...
        self.subscribe(f"$iothub/methods/POST/{name}/#", handler)
    ...
    def on_event(self, type: str, cb):
        ...
        self.subscribe(f"ombori/grid/message/{type}", handler)

    def broadcast(self, type: str, payload):
        data = json.dumps(payload)
        self.publish(f"ombori/grid/message/{type}", data)
