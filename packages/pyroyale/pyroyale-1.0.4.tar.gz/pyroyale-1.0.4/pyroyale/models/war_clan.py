...
class WarClan(object):
    ...
    def __init__(self, tag=None, name=None, badge_id=None, clan_score=None, participants=None, crowns=None, battles_remaining=None, battles_played=None, wins=None, local_vars_configuration=None):  # noqa: E501
