...
class BattleLogEntry(object):
    ...
    def __init__(self, type=None, battle_time=None, is_ladder_tournament=None, arena=None, game_mode=None, deck_selection=None, team=None, opponent=None, local_vars_configuration=None):  # noqa: E501
