...
class TournamentDetail(object):
    ...
    def __init__(self, tag=None, type=None, status=None, level_cap=None, first_place_card_prize=None, creator_tag=None, name=None, description=None, capacity=None, max_capacity=None, preparation_duration=None, duration=None, created_time=None, game_mode=None, started_time=None, members_list=None, local_vars_configuration=None):  # noqa: E501
