...
class BattleLogTeam(object):
    ...
    def __init__(self, tag=None, name=None, starting_trophies=None, trophy_change=None, crowns=None, king_tower_hit_points=None, princess_towers_hit_points=None, clan=None, cards=None, local_vars_configuration=None):  # noqa: E501
