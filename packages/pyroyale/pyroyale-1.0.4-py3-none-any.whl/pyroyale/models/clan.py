...
class Clan(object):
    ...
    def __init__(self, tag=None, name=None, badge_id=None, type=None, clan_score=None, required_trophies=None, donations_per_week=None, clan_war_trophies=None, clan_chest_level=None, clan_chest_max_level=None, members=None, location=None, description=None, clan_chest_status=None, clan_chest_points=None, member_list=None, local_vars_configuration=None):  # noqa: E501
