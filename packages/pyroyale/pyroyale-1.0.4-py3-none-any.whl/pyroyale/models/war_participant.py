...
class WarParticipant(object):
    ...
    def __init__(self, tag=None, name=None, cards_earned=None, battles_played=None, collection_day_battles_played=None, wins=None, number_of_battles=None, local_vars_configuration=None):  # noqa: E501
