...
class ClanMember(object):
    ...
    def __init__(self, tag=None, name=None, exp_level=None, trophies=None, arena=None, role=None, last_seen=None, clan_rank=None, previous_clan_rank=None, donations=None, donations_received=None, clan_chest_points=None, local_vars_configuration=None):  # noqa: E501
