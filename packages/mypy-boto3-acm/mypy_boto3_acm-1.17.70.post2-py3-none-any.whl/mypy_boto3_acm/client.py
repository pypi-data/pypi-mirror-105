...
class ACMClient:
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.70/reference/services/acm.html#ACM.Paginator.ListCertificates)[Show boto3-stubs documentation](./paginators.md#listcertificatespaginator)
        """
    ...
    def get_waiter(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.70/reference/services/acm.html#ACM.Waiter.certificate_validated)[Show boto3-stubs documentation](./waiters.md#certificatevalidatedwaiter)
        """
