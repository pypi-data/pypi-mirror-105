...
class AlarmExistsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.68/reference/services/cloudwatch.html#CloudWatch.Waiter.AlarmExistsWaiter)
...
class CompositeAlarmExistsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.68/reference/services/cloudwatch.html#CloudWatch.Waiter.CompositeAlarmExistsWaiter)
