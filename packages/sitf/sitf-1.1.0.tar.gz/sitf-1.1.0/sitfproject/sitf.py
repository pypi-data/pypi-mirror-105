...
def main():
    ...
    parser = argparse.ArgumentParser(description='Image file sorter By Shatak Gurukar.')
    ...
    os.chdir(args.path)
    logging.basicConfig(format='%(asctime)s %(message)s', datefmt='%d/%m/%Y %I:%M:%S %p', filename='sitf.log', encoding='utf-8', level=logging.INFO)
