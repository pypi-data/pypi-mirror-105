...
urlpatterns += [
    path('doctrines/create/',
         permission_required(
             'django_eveonline_doctrine_manager.add_evedoctrine', raise_exception=True)
...
urlpatterns += [
    path('fittings/create',
         permission_required(
             'django_eveonline_doctrine_manager.add_evefitting', raise_exception=True)
         (fittings.FittingCreateView.as_view()),
         name="django-eveonline-doctrine-manager-fittings-create"),

    path('fittings',
         permission_required(
             'django_eveonline_doctrine_manager.view_evefitting', raise_exception=True)
    ...
    path('fittings/update/<int:id>',
         permission_required(
             'django_eveonline_doctrine_manager.change_evefitting', raise_exception=True)
         (fittings.FittingUpdateView.as_view()),
         name="django-eveonline-doctrine-manager-fittings-update"),

    path('fittings/delete/<int:id>',
         permission_required(
             'django_eveonline_doctrine_manager.delete_evefitting', raise_exception=True)
