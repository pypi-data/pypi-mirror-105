...
- Avoid _zombie_ device server processes left after running
  the `ProcessStarter` on Windows

## [4.7.1] - 2021-04-08

Hotfix to avoid Tango client app crashes on Windows

### Fixed
- Tango client application crashes at exit on Windows (#709)
...
[4.7.1.1]: https://gitlab.com/taurus-org/taurus/-/releases/4.7.1.1
[4.7.1]: https://gitlab.com/taurus-org/taurus/-/releases/4.7.1
