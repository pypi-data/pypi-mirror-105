...
class VesselLeakFlammableLinkedRunCalculation(Calculation):
	...
	def __init__(self):
		...
		# Distances to explosion overpressure levels
		self.distancesToExplosionOverpressure = []
	...
	def run(self) -> ResultCode:
		...
		if response.ok:
			...
			if (self.resultCode == ResultCode.SUCCESS):
				...
				self.distancesToExplosionOverpressure = vesselLeakFlammableLinkedRunCalculationResponse.distancesToExplosionOverpressure
	...
	def print(self):
		...
		# distancesToExplosionOverpressure
		for item in self.distancesToExplosionOverpressure:
			print('{0}'.format(item))
...
class VesselLeakFlammableLinkedRunCalculationResponse(object):
	...
	def initialiseFromDictionary(self, data: dict):
		...
		# Distances to explosion overpressure levels
		for dataItem in data['distancesToExplosionOverpressure']:
			self.distancesToExplosionOverpressure.append(float(dataItem))
...
class LoadMassInventoryVesselForLeakScenarioCalculationRequest(object):
	...
	def __init__(self):
		...
		# Description for entry point parameter holeSize not found.
		self.holeSize = 0.0
