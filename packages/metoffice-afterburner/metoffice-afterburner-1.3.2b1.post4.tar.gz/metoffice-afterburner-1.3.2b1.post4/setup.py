...
class TestRunner(Command):
    ...
    """
    # Set matplotlib to use the Agg environment so that tests will pass on
    # headless servers
    #import matplotlib
    #matplotlib.use('Agg')
...
setup(
    ...
    py_modules=['bootstrap', 'package_logger'],
    packages=find_packages('lib'),
    package_dir={'': 'lib'},
    package_data={},
    scripts=find_scripts(),
    install_requires=['scitools-iris>=2.1,<3', 'pyparsing>=2', 'windspharm'],
    python_requires='>=2.7',
    tests_require=['nose>=1.0'],
    cmdclass={
        'test': TestRunner, 'build_docs': BuildDocs,
