...
class Workflow(Base):
    ...
    def __init__(self, name=None, workload_id=None, life_time=None, pending_time=None, logger=None):
        """
        Init a workflow.
        """
    ...
    @property
    def life_time(self):
        return self.get_metadata_item('life_time', None)

    @life_time.setter
    def life_time(self, value):
        self.add_metadata_item('life_time', value)
    ...
    def refresh_works(self):
        ...
        if self._works:
            for k in self._works:
                ...
                if work.last_updated_at and self.last_updated_at and work.last_updated_at > self.last_updated_at:
