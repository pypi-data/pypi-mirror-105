...
if __name__ == '__main__':
    tex = r"\left[\begin{matrix}- \sqrt{14} i & -2 & -1\\0 & - \frac{5 \sqrt{14} i}{7} & -3 + \frac{\sqrt{14} i}{7}\\0 & 3 + \frac{\sqrt{14} i}{7} & - \frac{13 \sqrt{14} i}{14}\end{matrix}\right]\xrightarrow{r_2+r_1}"
