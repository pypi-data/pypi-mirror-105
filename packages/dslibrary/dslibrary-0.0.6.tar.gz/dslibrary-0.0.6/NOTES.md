...
a full use case includes...
  dsw://  - access to data service (i.e. point to specific resource)
  ./abc.csv - access to local file
  big.csv - access to not always local file (i.e. remotely running through DSW)
  "x" - named inputs
