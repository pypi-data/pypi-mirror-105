...
def create_merchant_customer_transaction_upstream_for_merchant(transaction_details, update_datetime=None):
    ...
    __create_upstream(transaction_details, CUSTOMER_TRANSACTION_TEMPLATE, MERCHANT_DATASET, final_table_name, update_datetime=update_datetime, Reverted=False, RevertedDateTime=None)
...
def create_merchant_customer_reward_upstream_for_merchant(transaction_details, reward_details, update_datetime=None):
    ...
    __create_upstream(transaction_details_with_reward_details, MERCHANT_CUSTOMER_REWARD_TEMPLATE, MERCHANT_DATASET, final_table_name, update_datetime=update_datetime)
