...
def run_backtest(
    ...
    if strategy_stats_original is not None and strategy_stats_original.short_name is not None:
        engine.strategy.strategy_name = strategy_stats_original.short_name
        file_name_header = f"{file_name_header}_[{strategy_stats_original.short_name}]"
        ...
        if save_stats:
            try:
                if strategy_stats_original is not None:
                    ...
                    old_id_name = strategy_stats_original.id_name
                else:
                    old_id_name = None
                ...
                StrategyBacktestStats.update_stats(
                    ...
                    engine_kwargs=engine_kwargs, statistics=statistics, charts_data=charts_data,
