...
packages = \
['euporie', 'euporie.libs.commonmark_extensions']
...
install_requires = \
['Pillow>=8.2.0,<9.0.0',
 'jupyter-client>=6.2.0,<7.0.0',
 'nbformat>=5.1.3,<6.0.0',
 'prompt-toolkit>=3.0.18,<4.0.0',
 'rich>=10.1.0,<11.0.0']

extras_require = \
{'images': ['timg>=1.1.5,<2.0.0'],
 'tables': ['mtable>=0.1.10,<0.2.0', 'html5lib>=1.1,<2.0']}
