...
#########################公共Error返回值
SMALLENDDATE_ERROR = '您好,检测到end_date比start_date要小哟,请修正后重新请求数据!'
DATENONE_ERROR = '您好,检测到end_date比start_date都是None,请修正后重新请求数据!'
...
NOTAUSSHARE_ERROR = '您好,接口暂时不提供美股/A股的数据哟,我们会马不停蹄的加班,尽快把数据补全!'
...
FIN_ONLY_HK_MARKET_ERROR = '您好,接口暂时不提供美股的数据哟,我们会马不停蹄的加班,尽快把美股的数据补全!'
FIN_LOSS_CODE_ERROR = '您好, 请填写code字段！'
FIN_DATENONE_ERROR = '您好,检测到end_date比start_date都是None,请修正后重新请求数据!'
############################ KaisaFinaData接口里的Error异常备注##############################
