...
with open(juan_motif_file) as file:
    with open(tmp_juan_motif_file, 'w') as outfile:
        for line in file:
            chrom, left, right, tsr_name, strand, _, _, _, _, truQuant_gene_name, motif, ratio = line.split()
...
# Get the sequence from -36 to -19 for each of the FUCKING REGIONS
...
with open(tmp_output_file) as file:
    for line in file:
        ...
        # ADARB2 was given to me. I have no clue why his bitch ass used this gene because it has less than 10 counts.
        # So, he didn't use the right fucking thing for his stupid meme analysis.
