...
class AbstractComponent(ABC):
    ...
    @classmethod
    def from_memory(cls, has_contract: bool=None, uri_pm_repo: str=None, default_save_intent: bool=None,
        ...
        has_contract = True if isinstance(uri_pm_repo, str) else has_contract
        ...
        return cls.from_env(task_name='temporary_in_memory_instance', default_save=False, has_contract=has_contract,
                            ...
                            uri_pm_repo=uri_pm_repo, **kwargs)
