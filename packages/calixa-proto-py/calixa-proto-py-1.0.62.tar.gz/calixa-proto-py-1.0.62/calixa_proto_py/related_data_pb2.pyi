...
class _RelatedDataFieldType(google___protobuf___internal___enum_type_wrapper____EnumTypeWrapper[RelatedDataFieldTypeValue]):
    ...
    RELATED_DATA_FIELD_TYPE_INT = typing___cast(RelatedDataFieldTypeValue, 1)
    RELATED_DATA_FIELD_TYPE_BOOLEAN = typing___cast(RelatedDataFieldTypeValue, 2)
    RELATED_DATA_FIELD_TYPE_STRING = typing___cast(RelatedDataFieldTypeValue, 3)
    RELATED_DATA_FIELD_TYPE_ENUM = typing___cast(RelatedDataFieldTypeValue, 4)
    RELATED_DATA_FIELD_TYPE_INSTANT = typing___cast(RelatedDataFieldTypeValue, 5)
RELATED_DATA_FIELD_TYPE_UNSPECIFIED = typing___cast(RelatedDataFieldTypeValue, 0)
RELATED_DATA_FIELD_TYPE_INT = typing___cast(RelatedDataFieldTypeValue, 1)
RELATED_DATA_FIELD_TYPE_BOOLEAN = typing___cast(RelatedDataFieldTypeValue, 2)
RELATED_DATA_FIELD_TYPE_STRING = typing___cast(RelatedDataFieldTypeValue, 3)
...
class RelatedData(google___protobuf___message___Message):
    ...
    def __init__(self,
        *,
        ...
        renderable : typing___Optional[builtin___bool] = None,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"associated_with",b"associated_with",u"display",b"display",u"field",b"field",u"field_type",b"field_type",u"has_other",b"has_other",u"properties",b"properties",u"renderable",b"renderable",u"values",b"values"]) -> None: ...
