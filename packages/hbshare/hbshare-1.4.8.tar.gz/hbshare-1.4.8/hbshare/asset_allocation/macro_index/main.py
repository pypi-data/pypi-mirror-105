...
class StockBondRotation:
    ...
    def _load_data(self):
        ...
        data = pd.merge(pe_data, treasury_data, on='trade_date')
        data['trade_date'] = data['trade_date'].apply(lambda x: datetime.strftime(x, '%Y%m%d'))
    ...
    def draw_picture_premium(self):
        ...
        line = Line(
            ...
            y_axis=[df_mean + df_std] * df.shape[0],
            is_symbol_show=False,
...
class StockIndexDiff:
    ...
    def draw_picture_index_diff(self):
        ...
        max_range = int(df['diff'].abs().max()) + 1
...
if __name__ == '__main__':
    ...
    # StockBondRotation(index_name='HS300').draw_picture_premium()
    # StockIndexDiff(start_date='20130101').draw_picture_index_diff()
    # StockCashFlowIndex(start_date='20200101').draw_picture_cash_flow()
    # StockTradingIndex().draw_picture_turn('sh')
    ...
    # TreasurySpreadIndex('20100101', '20210423').draw_picture_treasury_yield('20210423', '20210416')
