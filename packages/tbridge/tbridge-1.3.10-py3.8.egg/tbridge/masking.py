...
def estimate_background_annulus(cutout, annulus_radius=50, annulus_width=10, dynamic=True):
    """
    ...
    bg_mask = make_source_mask(cutout, nsigma=2, npixels=2, dilate_size=7)
