...
def normalized_median(normalized_profiles):
    median_prof = median(normalized_profiles, axis=0)
    # print(median_prof.shape)
    return median_prof


def normalized_bootstrap(normalized_profiles, iterations=1001, gaussian=True):
    ...
    for i in range(iterations):
        ...
        medians.append(normalized_median(pop))
