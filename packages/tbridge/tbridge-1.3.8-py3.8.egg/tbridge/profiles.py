import tbridge
from numpy import trapz, copy, isnan, isinf, log10, arange, max, gradient, median, std
...
def profile_asymptote(x, y, step=0.5, smooth=True, threshold=1e-4):
    """
    ...
    # Return the asymptote and the spread of values in asymptotic numbers
    return median(y_good), std(y_good)