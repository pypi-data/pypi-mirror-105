...
class SpaceRegionExtractor:
    ...
    def extract_regions_from_image(self, page, algoithm='adaptive', threshold=230):
        ...
        self.min_area_height=MIN_AREA_HIEGHT*2
        self.min_area_width=image.shape[1]/5
        ...
        regions = self.regions_from_spaces(img_blur, page, vertical_separator_width=DEFAULT_X_SEPARATOR_WIDTH, horizental_separator_width=DEFAULT_Y_SEPARATOR_HEIGHT, method='pixels')
