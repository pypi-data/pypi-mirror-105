    ...
    def cluster(self, cpu: int=None, memory: int=None):
        ...
        ondemand_cpu_mem = {
            ...
            8: {
                16: ["ecs.c5.2xlarge"], 
                32: ["ecs.g5.2xlarge"], 
                64: ["ecs.r5.2xlarge", "ecs.se1.2xlarge",  "ecs.se1ne.2xlarge"]
            },
            16: {
                32: ["ecs.c5.4xlarge"], 64: ["ecs.g5.4xlarge"], 128: ["ecs.r5.4xlarge", "ecs.se1.4xlarge",  "ecs.se1ne.4xlarge"]
            },
            24: {
                48: ["ecs.c5.6xlarge"], 96: ["ecs.g5.6xlarge"], 192: ["ecs.r5.6xlarge"]
            },
            32: {
                64: ["ecs.c5.8xlarge"], 128: ["ecs.g5.8xlarge"], 256: ["ecs.r5.8xlarge", "ecs.se1.8xlarge", "ecs.se1ne.8xlarge"]
            },
            56: { 480: ["ecs.se1.14xlarge","ecs.se1ne.14xlarge"]},
            64: {
                128: ["ecs.c5.16xlarge"], 256: ["ecs.g5.16xlarge"], 512: ["ecs.r5.16xlarge"]
            }
        }

        cpu2mem = spot_cpu_mem if rescource_type == 'Spot' else ondemand_cpu_mem
