...
@mock.patch('citibox.gcloudlogger.contrib.django.django_base_record_factory.HttpRequest')
class TestDjangoBaseRecordFactory(unittest.TestCase):
    ...
    def test_process_request_get_http(self, request_mock):
        ...
        base_record = DjangoBaseRecordFactory(
            logger=FakeLogger(),
    ...
    def test_process_request_post_pubsub_http(self, request_mock):
        ...
        request_mock.META = {
            "HTTP_HEADER_1": "header_1",
            "HTTP_USER_AGENT": DjangoBaseRecordFactory.PUBSUB_USER_AGENT
        }
        request_mock.POST = {
            "message": {
