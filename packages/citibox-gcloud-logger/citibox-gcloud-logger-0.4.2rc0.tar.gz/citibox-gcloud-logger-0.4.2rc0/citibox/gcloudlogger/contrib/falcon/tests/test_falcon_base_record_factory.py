...
@mock.patch('citibox.gcloudlogger.contrib.falcon.falcon_base_record_factory.falcon.Response')
@mock.patch('citibox.gcloudlogger.contrib.falcon.falcon_base_record_factory.falcon.Request')
class TestFalconBaseRecordFactory(unittest.TestCase):
    ...
    def test_process_request_get_http(self, request_mock, response_mock):
        ...
        base_record = FalconBaseRecordFactory(request=request_mock, response=response_mock, params={}).build()
    ...
    def test_process_request_post_pubsub(self, request_mock, response_mock):
        ...
        request_mock.path = "/test_path"
        request_mock.headers = {"header-a": "A"}
        request_mock.user_agent = FalconBaseRecordFactory.PUBSUB_USER_AGENT
