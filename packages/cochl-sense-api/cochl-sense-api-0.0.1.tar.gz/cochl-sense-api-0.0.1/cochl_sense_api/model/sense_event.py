...
class SenseEvent(ModelNormal):
    ...
    def __init__(self, probability, start_time, end_time, tag, *args, **kwargs):  # noqa: E501
        ...
        Args:
            probability (float): probablity that the event occured. 0. means not possible at all and  1. means that it is certain 
            start_time (float): represent start of the window, in second, where inference was done. Note that start_time will increase by window_hop on every step 
            end_time (float): represent end of the window, in second where inference was done. Note that end_time is window_length after start_time 
