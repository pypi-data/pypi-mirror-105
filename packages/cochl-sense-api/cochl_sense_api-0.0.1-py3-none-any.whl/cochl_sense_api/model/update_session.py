...
class UpdateSession(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            make_readonly (bool): if set to true, will set session state to readonly              *Note that setting make_readonly to false once session is readonly will not make the session writeable again* . [optional]  # noqa: E501
        """
