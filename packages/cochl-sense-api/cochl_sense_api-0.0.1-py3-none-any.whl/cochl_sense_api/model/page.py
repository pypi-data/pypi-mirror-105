...
class Page(ModelNormal):
    ...
    def __init__(self, offset, count, total, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            total (int): the total number of available element in the collection at the moment 
        ...
        Keyword Args:
            ...
            next_token (str): next token can be used in the next page request to get following  results. If not present, it means that page has reach the end of  collection . [optional]  # noqa: E501
        """
