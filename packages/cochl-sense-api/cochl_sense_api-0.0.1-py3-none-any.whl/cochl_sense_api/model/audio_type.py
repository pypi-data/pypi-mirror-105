...
class AudioType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): wether the audio that will be sent is a stream or a file ., must be one of ["stream", "file", ]  # noqa: E501

        Keyword Args:
            value (str): wether the audio that will be sent is a stream or a file ., must be one of ["stream", "file", ]  # noqa: E501
