...
class ConcatTest(unittest.TestCase):
    ...
    def test_one_moreparams(self):
        ...
        self.assertSequenceEqual(result, [5, 9, 15, 36, 6,10,16,37])

    def test_more_oneparam(self):
        p = ffeat.flow.Concat(_f2(1), _f2(11), _f2(101))
        result, kargs = p(5)
        self.assertSequenceEqual(result, [5, 6, 16, 106])

    def test_more_moreparam(self):
        p = ffeat.flow.Concat(_f2(1), _f2(11), _f2(101))
        result, kargs = p(3, 4, 7)
        self.assertSequenceEqual(result, [3, 4, 7, 4, 5, 8, 14, 15, 18, 104, 105, 108])
