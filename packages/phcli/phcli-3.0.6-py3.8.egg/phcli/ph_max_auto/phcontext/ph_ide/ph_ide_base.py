                    ...
                    "Step": {
                        ...
                        "HadoopJarStep": {
                            ...
                            "Args": ["spark-submit",
                                     "--deploy-mode", "cluster",
                                     "--py-files",
                                     "s3://ph-platform/2020-11-11/jobs/python/phcli/common/phcli-3.0.6-py3.8.egg," + s3_dag_path + job + "/phjob.py",
                        ...
                        "Step": {
                            ...
                            "HadoopJarStep": {
                                ...
                                "Args": ["spark-submit",
                                         "--deploy-mode", "cluster",
                                         "--py-files",
                                         "s3://ph-platform/2020-11-11/jobs/python/phcli/common/phcli-3.0.6-py3.8.egg," + s3_dag_path + parallel_job + "/phjob.py",
