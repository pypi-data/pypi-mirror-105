...
class DescribeServicesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.70/reference/services/pricing.html#Pricing.Paginator.DescribeServices.paginate)
...
class GetAttributeValuesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.70/reference/services/pricing.html#Pricing.Paginator.GetAttributeValues.paginate)
...
class GetProductsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.70/reference/services/pricing.html#Pricing.Paginator.GetProducts.paginate)
