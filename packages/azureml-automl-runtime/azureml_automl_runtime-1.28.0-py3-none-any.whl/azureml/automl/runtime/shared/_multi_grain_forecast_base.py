...
class _MultiGrainForecastBase:
    ...
    def _remove_origin_dependant_info_for_classical_forecasting_algo(
        ...
        time_and_grain_column_list = [self.time_column_name] + self.grain_column_names
        columns_to_keep = [
            constants.TimeSeriesInternal.DUMMY_TARGET_COLUMN] + time_and_grain_column_list + exogenous_colnames
