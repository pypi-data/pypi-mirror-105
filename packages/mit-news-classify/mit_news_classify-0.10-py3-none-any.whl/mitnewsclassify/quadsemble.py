...
def initialize( modelfile="model_quadsemble.h5", 
    ...
    pwd += "/data/quadsemble/" if google == False else "/gdata/quadsemble/"
    if (not os.path.isdir(pwd)):
        ...
        if answer == 'y':
            download.download('quadsemble', google)
...
def getprob(txt, google=False):
    ...
    vec0 = np.concatenate((vec0, doc2vec.getfeatures(txt, google)), axis=1)
    vec0 = np.concatenate((vec0, distilbert.getfeatures(txt, google)), axis=1)
    # print(vec0)
