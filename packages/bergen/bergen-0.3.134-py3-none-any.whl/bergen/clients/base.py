import asyncio
from bergen.wards.main import MainWard
...
class BaseBergen:
    ...
    async def negotiate_async(self):
        ...
        self.identifierWardMap = {model.identifier.lower(): datapoint_registry.create_ward(self, model.point) for model in self._transcript.models}

        # Negotating Extensions for the Datapoints
        self._extensions = await datapoint_registry.configure_wards()
