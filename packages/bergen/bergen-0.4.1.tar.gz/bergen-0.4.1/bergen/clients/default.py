from bergen.auths.code.app import AuthroizationCodeApplication
...
class Bergen(BaseBergen):
    ...
    **kwargs) -> None:
        ...
        if herre_config.authorization_grant_type == GrantType.AUHORIZATION_CODE: auth = AuthroizationCodeApplication(herre_config, force_new_token=force_new_token)
