...
class Ui_DialogNewContract(object):
    def setupUi(self, DialogNewContract):
        ...
        DialogNewContract.resize(417, 176)
        ...
        self.lineFirstDelivery = QLineEdit(DialogNewContract)
        self.lineFirstDelivery.setObjectName(u"lineFirstDelivery")
        self.lineFirstDelivery.setMaximumSize(QSize(160, 16777215))

        self.horizontalLayout_2.addWidget(self.lineFirstDelivery)
