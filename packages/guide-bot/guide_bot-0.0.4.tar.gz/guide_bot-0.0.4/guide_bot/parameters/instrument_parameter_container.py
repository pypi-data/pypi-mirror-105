...
class InstrumentParameterContainer:
    ...
    def add_parameter(self, parameter):
        ...
        if isinstance(parameter, FreeInstrumentParameter):
    ...
    def set_values(self, optimizer_x):
        ...
        """
        if len(self.free_parameters) != len(optimizer_x):
            raise ValueError("Mismatch between number of free parameters"
                             + " and length of given state!")

        for par, given_value in zip(self.free_parameters, optimizer_x):
    ...
    def fix_free_parameters(self, other_container, exclude=None):
        """
        Fix free parameters in this container using values from other_container
        ...
        """
        for free_par in other_container.free_parameters:
